...
class WebServiceView extends GetView<WebServiceController> {
  const WebServiceView({super.key});

  static const String routeName = '/web-service';
  static final WebNavSection section = WebNavData.bySlug('service');
...
class _SearchBar extends StatelessWidget {
  final WebServiceController controller;
  final Color color;
