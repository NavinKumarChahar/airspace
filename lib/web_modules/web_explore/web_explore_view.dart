// web_modules/web_explore/web_explore_view.dart
...
class WebExploreView extends GetView<WebExploreController> {
  const WebExploreView({super.key});

  static const String routeName = '/web-explore';
  static final WebNavSection section = WebNavData.bySlug('explore');
...
class _SearchBar extends StatelessWidget {
  final WebExploreController controller;
  final Color color;
