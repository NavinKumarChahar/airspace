...
class WebMotivationView extends GetView<WebMotivationController> {
  const WebMotivationView({super.key});

  static const String routeName = '/web-motivation';
  static final WebNavSection section = WebNavData.bySlug('motivation');
...
class _SearchBar extends StatelessWidget {
  final WebMotivationController controller;
  final Color color;
