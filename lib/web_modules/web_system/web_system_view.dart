// web_modules/web_system/web_system_view.dart
...
class WebSystemView extends GetView<WebSystemController> {
  const WebSystemView({super.key});

  static const String routeName = '/web-system';
  static final WebNavSection section = WebNavData.bySlug('system');
...
class _SearchBar extends StatelessWidget {
  final WebSystemController controller;
  final Color color;
