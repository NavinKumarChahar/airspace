...
class WebAspectsView extends GetView<WebAspectsController> {
  const WebAspectsView({super.key});

  static const String routeName = '/web-aspects';
  static final WebNavSection section = WebNavData.bySlug('aspects');
...
class _SearchBar extends StatelessWidget {
  final WebAspectsController controller;
  final Color color;
