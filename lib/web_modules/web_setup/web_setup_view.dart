// web_modules/web_setup/web_setup_view.dart
...
class WebSetupView extends GetView<WebSetupController> {
  const WebSetupView({super.key});

  static const String routeName = '/web-setup';
  static final WebNavSection section = WebNavData.bySlug('setup');
...
class _SearchBar extends StatelessWidget {
  final WebSetupController controller;
  final Color color;
