...
class WebWisdomView extends GetView<WebWisdomController> {
  const WebWisdomView({super.key});

  static const String routeName = '/web-wisdom';
  static final WebNavSection section = WebNavData.bySlug('wisdom');
...
class _SearchBar extends StatelessWidget {
  final WebWisdomController controller;
  final Color color;
