...
class KindnessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Kindness meaningful — clarified, named, and put to work in daily decisions.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Kindness over weeks, months and years.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Kindness is alive in your life — not as theory, but as visible results.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Kindness stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.loyalty_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Kindness carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When kindness becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
