...
/// Auto-generated unique themed wrapper for Research Development.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ResearchDevelopmentView is embedded below the new sections).
///
/// Theme: Magenta Pulse | Layout: wave
class ResearchDevelopmentEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ResearchDevelopmentEnhancedView({
