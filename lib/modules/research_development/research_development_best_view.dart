...
class ResearchDevelopmentBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Research Development meaningful — clarified, named, and put to work in daily decisions.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Research Development over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Research Development is alive in your life — not as theory, but as visible results.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Research Development stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.local_fire_department_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Research Development carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Research Development is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When research development becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: ResearchDevelopmentEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: ResearchDevelopmentView(isEmbedded: true)),
