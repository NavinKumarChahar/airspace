...
class SafetyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Safety meaningful — clarified, named, and put to work in daily decisions.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Safety over weeks, months and years.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Safety is alive in your life — not as theory, but as visible results.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Safety stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.auto_awesome_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Safety carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When safety becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: SafetyEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: SafetyView(isEmbedded: true)),
