...
class FeedbackBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Feedback meaningful — clarified, named, and put to work in daily decisions.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Feedback over weeks, months and years.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Feedback is alive in your life — not as theory, but as visible results.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Feedback stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.shield_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Feedback carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When feedback becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: FeedbackEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: FeedbackView(isEmbedded: true)),
