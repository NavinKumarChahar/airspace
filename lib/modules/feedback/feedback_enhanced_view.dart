...
/// Auto-generated unique themed wrapper for Feedback.
/// Adds a fresh design + new content sections while preserving original content
/// (the original FeedbackView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: burst
class FeedbackEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const FeedbackEnhancedView({this.isEmbedded = false, required this.isDark});
