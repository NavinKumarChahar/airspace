...
/// DemonstrationBestView
/// Auto-generated showcase view — Design Pattern: Cyan / hero:orb / section:accordion.
/// Wraps and preserves the original DemonstrationView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class DemonstrationBestView extends StatelessWidget {
  const DemonstrationBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Demonstration meaningful — clarified, named, and put to work in daily decisions.", Icons.insights_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Demonstration over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Demonstration is alive in your life — not as theory, but as visible results.", Icons.explore_rounded),
      _Pillar("Frontiers", "Where Demonstration stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.insights_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Demonstration carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Demonstration.",
      "Share an insight about Demonstration with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Demonstration.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Demonstration is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Demonstration', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.insights_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When demonstration becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const DemonstrationView()),
