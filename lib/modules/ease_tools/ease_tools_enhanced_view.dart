...
/// Auto-generated unique themed wrapper for Ease Tools.
/// Adds a fresh design + new content sections while preserving original content
/// (the original EaseToolsView is embedded below the new sections).
///
/// Theme: Royal Plum | Layout: grid
class EaseToolsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const EaseToolsEnhancedView({this.isEmbedded = false, required this.isDark});
  ...
  static const Color _soft = Color(0xffe9d5ff);
