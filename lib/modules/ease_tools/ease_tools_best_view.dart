...
import 'ease_tools_view.dart';

/// EaseToolsBestView
/// Auto-generated showcase view — Design Pattern: Indigo / hero:orb / section:accordion.
/// Wraps and preserves the original EaseToolsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class EaseToolsBestView extends StatelessWidget {
  const EaseToolsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Ease Tools meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Ease Tools over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Ease Tools is alive in your life — not as theory, but as visible results.", Icons.insights_rounded),
      _Pillar("Frontiers", "Where Ease Tools stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Ease Tools carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Ease Tools.",
      "Share an insight about Ease Tools with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Ease Tools.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Ease Tools is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Ease Tools', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When ease tools becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const EaseToolsView()),
