...
import 'queries_view.dart';

/// QueriesBestView
/// Auto-generated showcase view — Design Pattern: Emerald / hero:orb / section:bento.
/// Wraps and preserves the original QueriesView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class QueriesBestView extends StatelessWidget {
  const QueriesBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Queries meaningful — clarified, named, and put to work in daily decisions.", Icons.shield_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Queries over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Queries is alive in your life — not as theory, but as visible results.", Icons.lightbulb_rounded),
      _Pillar("Frontiers", "Where Queries stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.shield_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Queries carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Queries.",
      "Share an insight about Queries with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Queries.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Queries is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Queries', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When queries becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const QueriesView()),
