...
import 'package:air_app/modules/queries/queries_enhanced_view.dart';
...
class QueriesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Queries meaningful — clarified, named, and put to work in daily decisions.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Queries over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Queries is alive in your life — not as theory, but as visible results.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Queries stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.shield_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Queries carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When queries becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: QueriesEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: QueriesView(isEmbedded: true)),
