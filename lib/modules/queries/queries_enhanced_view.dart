...
/// Auto-generated unique themed wrapper for Queries.
/// Adds a fresh design + new content sections while preserving original content
/// (the original QueriesView is embedded below the new sections).
///
/// Theme: Rose Petal | Layout: grid
class QueriesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const QueriesEnhancedView({this.isEmbedded = false, required this.isDark});
