...
import 'monitorship_view.dart';

/// MonitorshipBestView
/// Auto-generated showcase view — Design Pattern: Lime / hero:split / section:accordion.
/// Wraps and preserves the original MonitorshipView at the bottom so no
...
class MonitorshipBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Monitorship meaningful — clarified, named, and put to work in daily decisions.", Icons.psychology_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Monitorship over weeks, months and years.", Icons.grain_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Monitorship is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Monitorship stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.psychology_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Monitorship carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Monitorship.",
      "Share an insight about Monitorship with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Monitorship.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Monitorship is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroSplit(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Monitorship', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.psychology_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When monitorship becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const MonitorshipView()),
