...
import 'package:air_app/modules/monitorship/monitorship_enhanced_view.dart';
...
class MonitorshipBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Monitorship meaningful — clarified, named, and put to work in daily decisions.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Monitorship over weeks, months and years.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Monitorship is alive in your life — not as theory, but as visible results.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Monitorship stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.psychology_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Monitorship carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When monitorship becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
