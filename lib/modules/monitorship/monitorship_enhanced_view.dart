...
/// Auto-generated unique themed wrapper for Monitorship.
/// Adds a fresh design + new content sections while preserving original content
/// (the original MonitorshipView is embedded below the new sections).
///
/// Theme: Twilight Lilac | Layout: diagonal
class MonitorshipEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const MonitorshipEnhancedView({
