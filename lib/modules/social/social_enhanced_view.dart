...
/// Auto-generated unique themed wrapper for Social.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SocialView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: rings
class SocialEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SocialEnhancedView({this.isEmbedded = false, required this.isDark});
