...
/// Auto-generated unique themed wrapper for Commerce.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CommerceView is embedded below the new sections).
///
/// Theme: Slate Steel | Layout: wave
class CommerceEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const CommerceEnhancedView({this.isEmbedded = false, required this.isDark});
