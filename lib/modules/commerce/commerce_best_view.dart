...
class CommerceBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Commerce meaningful — clarified, named, and put to work in daily decisions.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Commerce over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Commerce is alive in your life — not as theory, but as visible results.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Commerce stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.auto_awesome_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Commerce carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When commerce becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: CommerceEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: CommerceView(isEmbedded: true)),
