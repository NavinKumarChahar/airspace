...
/// AboutAppBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:arch / section:gallery.
...
class AboutAppBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make About App meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of About App over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove About App is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where About App stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch About App carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of About App.",
      "Share an insight about About App with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on About App.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when About App is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'About App', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When about app becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
