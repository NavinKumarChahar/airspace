...
class AboutAppBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make About App meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of About App over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove About App is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where About App stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch About App carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: AboutEnhancedView(isEmbedded: true)),
