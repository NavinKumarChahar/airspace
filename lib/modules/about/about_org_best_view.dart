...
import 'about_org_view.dart';

/// AboutOrgBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:arch / section:gallery.
...
class AboutOrgBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make About Org meaningful — clarified, named, and put to work in daily decisions.", Icons.explore_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of About Org over weeks, months and years.", Icons.insights_rounded),
      _Pillar("Outcomes", "Tangible markers that prove About Org is alive in your life — not as theory, but as visible results.", Icons.flag_rounded),
      _Pillar("Frontiers", "Where About Org stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.explore_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch About Org carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of About Org.",
      "Share an insight about About Org with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on About Org.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when About Org is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'About Org', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When about org becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
