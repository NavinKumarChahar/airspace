...
class AboutOrgBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make About Org meaningful — clarified, named, and put to work in daily decisions.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of About Org over weeks, months and years.",
      Icons.insights_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove About Org is alive in your life — not as theory, but as visible results.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where About Org stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.explore_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch About Org carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When about org becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AboutOrgView(isEmbedded: true)),
