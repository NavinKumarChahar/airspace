...
/// Auto-generated unique themed wrapper for Your Business.
/// Adds a fresh design + new content sections while preserving original content
/// (the original YourBusinessView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: grid
class YourBusinessEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const YourBusinessEnhancedView({
