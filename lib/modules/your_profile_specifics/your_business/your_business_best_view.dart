...
import 'package:air_app/modules/your_profile_specifics/your_business/your_business_enhanced_view.dart';
...
class YourBusinessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Your Business meaningful — clarified, named, and put to work in daily decisions.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Your Business over weeks, months and years.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Your Business is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Your Business stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.bolt_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Your Business carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Your Business is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When your business becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: YourBusinessEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: YourBusinessView(isEmbedded: true)),
