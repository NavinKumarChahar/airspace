...
import 'your_business_view.dart';

/// YourBusinessBestView
/// Auto-generated showcase view — Design Pattern: Ocean / hero:prism / section:gallery.
/// Wraps and preserves the original YourBusinessView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class YourBusinessBestView extends StatelessWidget {
  const YourBusinessBestView({super.key});
  ...
  static const Color _bgDark    = Color(0xFF021125);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Your Business meaningful — clarified, named, and put to work in daily decisions.", Icons.bolt_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Your Business over weeks, months and years.", Icons.flare_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Your Business is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Your Business stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.bolt_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Your Business carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Your Business.",
      "Share an insight about Your Business with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Your Business.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Your Business is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Your Business', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When your business becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const YourBusinessView()),
