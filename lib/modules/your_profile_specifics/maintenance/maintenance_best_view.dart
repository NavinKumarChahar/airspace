...
/// MaintenanceBestView
/// Auto-generated showcase view — Design Pattern: Rose / hero:stripes / section:numbered.
/// Wraps and preserves the original MaintenanceView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class MaintenanceBestView extends StatelessWidget {
  const MaintenanceBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Maintenance meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Maintenance over weeks, months and years.", Icons.public_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Maintenance is alive in your life — not as theory, but as visible results.", Icons.grain_rounded),
      _Pillar("Frontiers", "Where Maintenance stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Maintenance carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Maintenance.",
      "Share an insight about Maintenance with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Maintenance.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Maintenance is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Maintenance', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.public_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When maintenance becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const MaintenanceView()),
