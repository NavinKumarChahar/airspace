...
import 'package:air_app/modules/your_profile_specifics/events/events_enhanced_view.dart';
...
class EventsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Events meaningful — clarified, named, and put to work in daily decisions.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Events over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Events is alive in your life — not as theory, but as visible results.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Events stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.favorite_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Events carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When events becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: EventsEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: EventsView(isEmbedded: true)),
