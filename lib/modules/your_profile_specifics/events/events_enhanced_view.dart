...
/// Auto-generated unique themed wrapper for Events.
/// Adds a fresh design + new content sections while preserving original content
/// (the original EventsView is embedded below the new sections).
///
/// Theme: Saffron Sun | Layout: stripes
class EventsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const EventsEnhancedView({this.isEmbedded = false, required this.isDark});
