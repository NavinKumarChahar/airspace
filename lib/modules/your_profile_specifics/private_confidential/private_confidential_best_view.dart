...
/// PrivateConfidentialBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:arch / section:numbered.
/// Wraps and preserves the original PrivateConfidentialView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class PrivateConfidentialBestView extends StatelessWidget {
  const PrivateConfidentialBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Private Confidential meaningful — clarified, named, and put to work in daily decisions.", Icons.public_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Private Confidential over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Private Confidential is alive in your life — not as theory, but as visible results.", Icons.auto_awesome_rounded),
      _Pillar("Frontiers", "Where Private Confidential stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.public_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Private Confidential carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Private Confidential.",
      "Share an insight about Private Confidential with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Private Confidential.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Private Confidential is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroArch(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Private Confidential', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.public_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 24),
              child: _NumberedBlock(steps: _steps, primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.psychology_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.auto_awesome_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When private confidential becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const PrivateConfidentialView()),
