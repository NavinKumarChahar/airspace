...
/// RewardsCreditsBestView
/// Auto-generated showcase view — Design Pattern: Aurora / hero:spiral / section:numbered.
/// Wraps and preserves the original RewardsCreditsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class RewardsCreditsBestView extends StatelessWidget {
  const RewardsCreditsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Rewards Credits meaningful — clarified, named, and put to work in daily decisions.", Icons.favorite_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Rewards Credits over weeks, months and years.", Icons.public_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Rewards Credits is alive in your life — not as theory, but as visible results.", Icons.flag_rounded),
      _Pillar("Frontiers", "Where Rewards Credits stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.favorite_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Rewards Credits carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Rewards Credits.",
      "Share an insight about Rewards Credits with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Rewards Credits.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Rewards Credits is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Rewards Credits', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When rewards credits becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const RewardsCreditsView()),
