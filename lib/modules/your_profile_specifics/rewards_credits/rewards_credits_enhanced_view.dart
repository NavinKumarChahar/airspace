...
/// Auto-generated unique themed wrapper for Rewards Credits.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RewardsCreditsView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: burst
class RewardsCreditsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RewardsCreditsEnhancedView({
