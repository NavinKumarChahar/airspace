...
import 'package:air_app/modules/your_profile_specifics/approval_appeals/approval_appeals_enhanced_view.dart';
...
class ApprovalAppealsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Approval Appeals meaningful — clarified, named, and put to work in daily decisions.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Approval Appeals over weeks, months and years.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Approval Appeals is alive in your life — not as theory, but as visible results.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Approval Appeals stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.star_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Approval Appeals carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Approval Appeals is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When approval appeals becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
