...
import 'approval_appeals_view.dart';

/// ApprovalAppealsBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:spiral / section:split.
/// Wraps and preserves the original ApprovalAppealsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ApprovalAppealsBestView extends StatelessWidget {
  const ApprovalAppealsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Approval Appeals meaningful — clarified, named, and put to work in daily decisions.", Icons.star_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Approval Appeals over weeks, months and years.", Icons.celebration_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Approval Appeals is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Approval Appeals stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.star_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Approval Appeals carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Approval Appeals.",
      "Share an insight about Approval Appeals with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Approval Appeals.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Approval Appeals is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Approval Appeals', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When approval appeals becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ApprovalAppealsView()),
