...
/// Auto-generated unique themed wrapper for Approval Appeals.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ApprovalAppealsView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: circles
class ApprovalAppealsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ApprovalAppealsEnhancedView({
