...
class ConnectCollaborateBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Connect Collaborate meaningful — clarified, named, and put to work in daily decisions.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Connect Collaborate over weeks, months and years.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Connect Collaborate is alive in your life — not as theory, but as visible results.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Connect Collaborate stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.favorite_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Connect Collaborate carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Connect Collaborate is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When connect collaborate becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
