...
/// Auto-generated unique themed wrapper for Connect Collaborate.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ConnectCollaborateView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: stripes
class ConnectCollaborateEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ConnectCollaborateEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Connect Collaborate',
          child: Text(
