...
/// Auto-generated unique themed wrapper for Network Apis.
/// Adds a fresh design + new content sections while preserving original content
/// (the original NetworkApisView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: diagonal
class NetworkApisEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const NetworkApisEnhancedView({
