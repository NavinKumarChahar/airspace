...
import 'package:air_app/modules/your_profile_specifics/network_apis/network_apis_enhanced_view.dart';
...
class NetworkApisBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Network Apis meaningful — clarified, named, and put to work in daily decisions.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Network Apis over weeks, months and years.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Network Apis is alive in your life — not as theory, but as visible results.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Network Apis stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.forest_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Network Apis carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When network apis becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: NetworkApisEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: NetworkApisView(isEmbedded: true)),
