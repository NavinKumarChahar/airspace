...
import 'network_apis_view.dart';

/// NetworkApisBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:spiral / section:badges.
/// Wraps and preserves the original NetworkApisView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class NetworkApisBestView extends StatelessWidget {
  const NetworkApisBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Network Apis meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Network Apis over weeks, months and years.", Icons.explore_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Network Apis is alive in your life — not as theory, but as visible results.", Icons.whatshot_rounded),
      _Pillar("Frontiers", "Where Network Apis stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Network Apis carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Network Apis.",
      "Share an insight about Network Apis with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Network Apis.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Network Apis is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Network Apis', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When network apis becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const NetworkApisView()),
