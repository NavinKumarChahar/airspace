...
import 'package:air_app/modules/your_profile_specifics/tracks_traces/tracks_traces_enhanced_view.dart';
...
class TracksTracesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Tracks Traces meaningful — clarified, named, and put to work in daily decisions.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Tracks Traces over weeks, months and years.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Tracks Traces is alive in your life — not as theory, but as visible results.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Tracks Traces stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.local_fire_department_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Tracks Traces carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Tracks Traces is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When tracks traces becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
