...
import 'tracks_traces_view.dart';

/// TracksTracesBestView
/// Auto-generated showcase view — Design Pattern: Coral / hero:orb / section:stats.
/// Wraps and preserves the original TracksTracesView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class TracksTracesBestView extends StatelessWidget {
  const TracksTracesBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Tracks Traces meaningful — clarified, named, and put to work in daily decisions.", Icons.local_fire_department_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Tracks Traces over weeks, months and years.", Icons.rocket_launch_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Tracks Traces is alive in your life — not as theory, but as visible results.", Icons.diamond_rounded),
      _Pillar("Frontiers", "Where Tracks Traces stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.local_fire_department_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Tracks Traces carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Tracks Traces.",
      "Share an insight about Tracks Traces with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Tracks Traces.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Tracks Traces is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Tracks Traces', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.diamond_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When tracks traces becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const TracksTracesView()),
