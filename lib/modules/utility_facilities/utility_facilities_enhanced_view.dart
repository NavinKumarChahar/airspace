...
/// Auto-generated unique themed wrapper for Utility Facilities.
/// Adds a fresh design + new content sections while preserving original content
/// (the original UtilityFacilitiesView is embedded below the new sections).
///
/// Theme: Bronze Age | Layout: wave
class UtilityFacilitiesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const UtilityFacilitiesEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Utility Facilities',
          child: Text(
