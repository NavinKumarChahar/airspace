...
/// Auto-generated unique themed wrapper for Marketing Promotion.
/// Adds a fresh design + new content sections while preserving original content
/// (the original MarketingPromotionView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: circles
class MarketingPromotionEnhancedView extends StatelessWidget {
  const MarketingPromotionEnhancedView({super.key});
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Marketing Promotion',
                child: Text(
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              ...
              child: const MarketingPromotionView(),
            ),
          ),
        ],
      ),
