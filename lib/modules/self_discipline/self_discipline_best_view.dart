...
import 'package:air_app/modules/self_discipline/self_discipline_enhanced_view.dart';
...
class SelfDisciplineBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Self Discipline meaningful — clarified, named, and put to work in daily decisions.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Self Discipline over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Self Discipline is alive in your life — not as theory, but as visible results.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Self Discipline stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.workspace_premium_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Self Discipline carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Self Discipline is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When self discipline becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: SelfDisciplineEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: SelfDisciplineView(isEmbedded: true)),
