...
class CountingReportsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Counting Reports meaningful — clarified, named, and put to work in daily decisions.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Counting Reports over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Counting Reports is alive in your life — not as theory, but as visible results.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Counting Reports stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.shield_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Counting Reports carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Counting Reports is paired with reflection",
    ),
