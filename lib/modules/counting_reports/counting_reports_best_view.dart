...
import 'counting_reports_view.dart';

/// CountingReportsBestView
/// Auto-generated showcase view — Design Pattern: Indigo / hero:arch / section:tabs.
...
class CountingReportsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Counting Reports meaningful — clarified, named, and put to work in daily decisions.", Icons.shield_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Counting Reports over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Counting Reports is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Counting Reports stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.shield_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Counting Reports carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Counting Reports.",
      "Share an insight about Counting Reports with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Counting Reports.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Counting Reports is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Counting Reports', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When counting reports becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const CountingReportsView()),
