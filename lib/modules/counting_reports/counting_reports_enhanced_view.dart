...
/// Auto-generated unique themed wrapper for Counting Reports.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CountingReportsView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: circles
class CountingReportsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const CountingReportsEnhancedView({
