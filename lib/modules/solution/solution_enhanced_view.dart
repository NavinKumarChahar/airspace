...
/// Auto-generated unique themed wrapper for Solution.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SolutionView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: diagonal
class SolutionEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SolutionEnhancedView({this.isEmbedded = false, required this.isDark});
