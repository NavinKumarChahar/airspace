...
/// SolutionBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:circles / section:gallery.
/// Wraps and preserves the original SolutionView at the bottom so no
...
class SolutionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Solution meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Solution over weeks, months and years.", Icons.forest_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Solution is alive in your life — not as theory, but as visible results.", Icons.local_fire_department_rounded),
      _Pillar("Frontiers", "Where Solution stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Solution carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Solution.",
      "Share an insight about Solution with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Solution.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Solution is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Solution', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When solution becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SolutionView()),
