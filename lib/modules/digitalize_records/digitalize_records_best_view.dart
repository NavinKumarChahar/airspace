...
/// DigitalizeRecordsBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:stripes / section:badges.
/// Wraps and preserves the original DigitalizeRecordsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class DigitalizeRecordsBestView extends StatelessWidget {
  const DigitalizeRecordsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Digitalize Records meaningful — clarified, named, and put to work in daily decisions.", Icons.insights_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Digitalize Records over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Digitalize Records is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Digitalize Records stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.insights_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Digitalize Records carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Digitalize Records.",
      "Share an insight about Digitalize Records with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Digitalize Records.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Digitalize Records is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Digitalize Records', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When digitalize records becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const DigitalizeRecordsView()),
