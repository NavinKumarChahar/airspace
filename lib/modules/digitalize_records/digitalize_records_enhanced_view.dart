...
/// Auto-generated unique themed wrapper for Digitalize Records.
/// Adds a fresh design + new content sections while preserving original content
/// (the original DigitalizeRecordsView is embedded below the new sections).
///
/// Theme: Royal Plum | Layout: burst
class DigitalizeRecordsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const DigitalizeRecordsEnhancedView({this.isEmbedded = false, required this.isDark});
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Digitalize Records',
                child: Text(
