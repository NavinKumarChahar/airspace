...
/// Wraps and preserves the original EntitiesView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class EntitiesBestView extends StatelessWidget {
  const EntitiesBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Entities meaningful — clarified, named, and put to work in daily decisions.", Icons.shield_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Entities over weeks, months and years.", Icons.favorite_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Entities is alive in your life — not as theory, but as visible results.", Icons.loyalty_rounded),
      _Pillar("Frontiers", "Where Entities stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.shield_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Entities carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Entities.",
      "Share an insight about Entities with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Entities.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Entities is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Entities', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When entities becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const EntitiesView()),
