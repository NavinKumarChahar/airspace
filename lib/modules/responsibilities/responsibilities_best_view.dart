...
import 'responsibilities_view.dart';

/// ResponsibilitiesBestView
/// Auto-generated showcase view — Design Pattern: Rose / hero:mesh / section:cards.
/// Wraps and preserves the original ResponsibilitiesView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ResponsibilitiesBestView extends StatelessWidget {
  const ResponsibilitiesBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Responsibilities meaningful — clarified, named, and put to work in daily decisions.", Icons.whatshot_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Responsibilities over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Responsibilities is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Responsibilities stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.whatshot_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Responsibilities carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Responsibilities.",
      "Share an insight about Responsibilities with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Responsibilities.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Responsibilities is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Responsibilities', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When responsibilities becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ResponsibilitiesView()),
