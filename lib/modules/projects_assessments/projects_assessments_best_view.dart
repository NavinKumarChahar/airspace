...
class ProjectsAssessmentsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Projects Assessments meaningful — clarified, named, and put to work in daily decisions.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Projects Assessments over weeks, months and years.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Projects Assessments is alive in your life — not as theory, but as visible results.",
      Icons.insights_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Projects Assessments stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.spa_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Projects Assessments carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Projects Assessments is paired with reflection",
    ),
