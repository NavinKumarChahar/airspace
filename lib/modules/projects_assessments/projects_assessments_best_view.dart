...
class ProjectsAssessmentsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Projects Assessments meaningful — clarified, named, and put to work in daily decisions.", Icons.spa_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Projects Assessments over weeks, months and years.", Icons.lightbulb_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Projects Assessments is alive in your life — not as theory, but as visible results.", Icons.insights_rounded),
      _Pillar("Frontiers", "Where Projects Assessments stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.spa_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Projects Assessments carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Projects Assessments.",
      "Share an insight about Projects Assessments with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Projects Assessments.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Projects Assessments is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Projects Assessments', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When projects assessments becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ProjectsAssessmentsView()),
