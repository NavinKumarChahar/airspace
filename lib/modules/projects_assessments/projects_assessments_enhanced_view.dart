...
/// Auto-generated unique themed wrapper for Projects Assessments.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ProjectsAssessmentsView is embedded below the new sections).
///
/// Theme: Twilight Lilac | Layout: burst
class ProjectsAssessmentsEnhancedView extends StatelessWidget {
  final bool isEmbedded;
  const ProjectsAssessmentsEnhancedView({super.key, this.isEmbedded = false});
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Projects Assessments',
                child: Text(
