...
class AffectionLoveBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Affection Love meaningful — clarified, named, and put to work in daily decisions.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Affection Love over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Affection Love is alive in your life — not as theory, but as visible results.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Affection Love stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.handshake_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Affection Love carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Affection Love is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When affection love becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AffectionLoveView(isEmbedded: true)),
