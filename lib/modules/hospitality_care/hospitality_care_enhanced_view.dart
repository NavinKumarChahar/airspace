...
/// Auto-generated unique themed wrapper for Hospitality Care.
/// Adds a fresh design + new content sections while preserving original content
/// (the original HospitalityCareView is embedded below the new sections).
///
/// Theme: Mint Spring | Layout: circles
class HospitalityCareEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const HospitalityCareEnhancedView({
