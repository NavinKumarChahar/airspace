...
class HospitalityCareBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Hospitality Care meaningful — clarified, named, and put to work in daily decisions.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Hospitality Care over weeks, months and years.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Hospitality Care is alive in your life — not as theory, but as visible results.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Hospitality Care stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.spa_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Hospitality Care carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Hospitality Care is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When hospitality care becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: HospitalityCareEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: HospitalityCareView(isEmbedded: true)),
