...
import 'package:air_app/modules/engagements/engagements_enhanced_view.dart';
...
class EngagementsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Engagements meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Engagements over weeks, months and years.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Engagements is alive in your life — not as theory, but as visible results.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Engagements stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Engagements carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When engagements becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: EngagementsEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: EngagementsView(isEmbedded: true)),
