...
/// Auto-generated unique themed wrapper for World.
/// Adds a fresh design + new content sections while preserving original content
/// (the original WorldView is embedded below the new sections).
///
/// Theme: Ocean Deep | Layout: diagonal
class WorldEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const WorldEnhancedView({this.isEmbedded = false, required this.isDark});
