...
/// Auto-generated unique themed wrapper for Rules Regulations.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RulesRegulationsView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: burst
class RulesRegulationsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RulesRegulationsEnhancedView({
