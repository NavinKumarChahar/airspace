...
/// Auto-generated unique themed wrapper for Heigher Studies.
/// Adds a fresh design + new content sections while preserving original content
/// (the original HeigherStudiesView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: diagonal
class HeigherStudiesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const HeigherStudiesEnhancedView({this.isEmbedded = false, required this.isDark});
