...
class HeigherStudiesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Heigher Studies meaningful — clarified, named, and put to work in daily decisions.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Heigher Studies over weeks, months and years.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Heigher Studies is alive in your life — not as theory, but as visible results.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Heigher Studies stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.diamond_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Heigher Studies carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Heigher Studies is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When heigher studies becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: HeigherStudiesEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: HeigherStudiesView(isEmbedded: true)),
