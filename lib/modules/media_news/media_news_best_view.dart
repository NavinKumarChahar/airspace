...
class MediaNewsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Media News meaningful — clarified, named, and put to work in daily decisions.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Media News over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Media News is alive in your life — not as theory, but as visible results.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Media News stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.shield_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Media News carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When media news becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          ...MediaNewsEnhancedView(isEmbedded: true, isDark: isDark).slivers,
