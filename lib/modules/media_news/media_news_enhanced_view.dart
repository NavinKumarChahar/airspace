...
/// Auto-generated unique themed wrapper for Media News.
/// Adds a fresh design + new content sections while preserving original content
/// (the original MediaNewsView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: rings
class MediaNewsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const MediaNewsEnhancedView({this.isEmbedded = false, required this.isDark});
