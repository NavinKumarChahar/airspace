...
import 'query_discussion_view.dart';

/// QueryDiscussionBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:stripes / section:accordion.
/// Wraps and preserves the original QueryDiscussionView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class QueryDiscussionBestView extends StatelessWidget {
  const QueryDiscussionBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Query Discussion meaningful — clarified, named, and put to work in daily decisions.", Icons.spa_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Query Discussion over weeks, months and years.", Icons.bolt_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Query Discussion is alive in your life — not as theory, but as visible results.", Icons.rocket_launch_rounded),
      _Pillar("Frontiers", "Where Query Discussion stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.spa_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Query Discussion carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Query Discussion.",
      "Share an insight about Query Discussion with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Query Discussion.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Query Discussion is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Query Discussion', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.spa_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 24),
              child: _AccordionBlock(pillars: _pillars, primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.bolt_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.rocket_launch_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When query discussion becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const QueryDiscussionView()),
