...
import 'package:air_app/modules/query_discussion/query_discussion_enhanced_view.dart';
...
class QueryDiscussionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Query Discussion meaningful — clarified, named, and put to work in daily decisions.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Query Discussion over weeks, months and years.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Query Discussion is alive in your life — not as theory, but as visible results.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Query Discussion stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.spa_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Query Discussion carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Query Discussion is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When query discussion becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: QueryDiscussionEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: QueryDiscussionView(isEmbedded: true)),
