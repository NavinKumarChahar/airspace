...
/// Auto-generated unique themed wrapper for Query Discussion.
/// Adds a fresh design + new content sections while preserving original content
/// (the original QueryDiscussionView is embedded below the new sections).
///
/// Theme: Forest Moss | Layout: rings
class QueryDiscussionEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const QueryDiscussionEnhancedView({
