...
import 'package:air_app/modules/empathy_sympathy/empathy_sympathy_enhanced_view.dart';
...
class EmpathySympathyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Empathy Sympathy meaningful — clarified, named, and put to work in daily decisions.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Empathy Sympathy over weeks, months and years.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Empathy Sympathy is alive in your life — not as theory, but as visible results.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Empathy Sympathy stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.interests_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Empathy Sympathy carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Empathy Sympathy is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When empathy sympathy becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: EmpathySympathyEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: EmpathySympathyView(isEmbedded: true)),
