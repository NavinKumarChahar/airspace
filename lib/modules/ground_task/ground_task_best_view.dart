...
import 'ground_task_view.dart';

/// GroundTaskBestView
/// Auto-generated showcase view — Design Pattern: Aurora / hero:prism / section:timeline.
/// Wraps and preserves the original GroundTaskView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class GroundTaskBestView extends StatelessWidget {
  const GroundTaskBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Ground Task meaningful — clarified, named, and put to work in daily decisions.", Icons.favorite_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Ground Task over weeks, months and years.", Icons.bolt_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Ground Task is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Ground Task stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.favorite_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Ground Task carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Ground Task.",
      "Share an insight about Ground Task with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Ground Task.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Ground Task is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Ground Task', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When ground task becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const GroundTaskView()),
