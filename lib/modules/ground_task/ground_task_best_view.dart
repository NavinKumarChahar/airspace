...
import 'package:air_app/modules/ground_task/ground_task_enhanced_view.dart';
...
class GroundTaskBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Ground Task meaningful — clarified, named, and put to work in daily decisions.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Ground Task over weeks, months and years.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Ground Task is alive in your life — not as theory, but as visible results.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Ground Task stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.favorite_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Ground Task carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When ground task becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: GroundTaskEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: GroundTaskView(isEmbedded: true)),
