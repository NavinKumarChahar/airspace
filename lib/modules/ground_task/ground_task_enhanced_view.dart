...
/// Auto-generated unique themed wrapper for Ground Task.
/// Adds a fresh design + new content sections while preserving original content
/// (the original GroundTaskView is embedded below the new sections).
///
/// Theme: Ember Forge | Layout: rings
class GroundTaskEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const GroundTaskEnhancedView({this.isEmbedded = false, required this.isDark});
