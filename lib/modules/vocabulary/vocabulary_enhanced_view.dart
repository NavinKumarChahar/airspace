...
/// Auto-generated unique themed wrapper for Vocabulary.
/// Adds a fresh design + new content sections while preserving original content
/// (the original VocabularyView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: rings
class VocabularyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const VocabularyEnhancedView({this.isEmbedded = false, required this.isDark});
