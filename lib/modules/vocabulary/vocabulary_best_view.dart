...
import 'package:air_app/modules/vocabulary/vocabulary_enhanced_view.dart';
...
class VocabularyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Vocabulary meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Vocabulary over weeks, months and years.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Vocabulary is alive in your life — not as theory, but as visible results.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Vocabulary stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Vocabulary carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When vocabulary becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
