...
/// Auto-generated unique themed wrapper for Utilities Guest.
/// Adds a fresh design + new content sections while preserving original content
/// (the original UtilitiesGuestView is embedded below the new sections).
///
/// Theme: Ocean Deep | Layout: stripes
class UtilitiesGuestEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const UtilitiesGuestEnhancedView({
