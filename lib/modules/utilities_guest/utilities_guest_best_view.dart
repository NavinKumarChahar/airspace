...
import 'utilities_guest_view.dart';

/// UtilitiesGuestBestView
/// Auto-generated showcase view — Design Pattern: Steel / hero:orb / section:timeline.
/// Wraps and preserves the original UtilitiesGuestView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class UtilitiesGuestBestView extends StatelessWidget {
  const UtilitiesGuestBestView({super.key});

  static const Color _primary   = Color(0xFF64748B);
  static const Color _secondary = Color(0xFF1E293B);
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Utilities Guest meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Utilities Guest over weeks, months and years.", Icons.flag_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Utilities Guest is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Utilities Guest stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Utilities Guest carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Utilities Guest.",
      "Share an insight about Utilities Guest with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Utilities Guest.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Utilities Guest is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Utilities Guest', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.flag_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When utilities guest becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
