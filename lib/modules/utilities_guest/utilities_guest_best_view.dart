...
import 'package:air_app/modules/utilities_guest/utilities_guest_enhanced_view.dart';
...
class UtilitiesGuestBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Utilities Guest meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Utilities Guest over weeks, months and years.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Utilities Guest is alive in your life — not as theory, but as visible results.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Utilities Guest stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Utilities Guest carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Utilities Guest is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When utilities guest becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: UtilitiesGuestEnhancedView(isEmbedded: true),
          ),
