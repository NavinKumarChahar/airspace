...
import 'package:air_app/modules/group_discussions/group_discussions_enhanced_view.dart';
...
class GroupDiscussionsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Group Discussions meaningful — clarified, named, and put to work in daily decisions.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Group Discussions over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Group Discussions is alive in your life — not as theory, but as visible results.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Group Discussions stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.handshake_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Group Discussions carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Group Discussions is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When group discussions becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: GroupDiscussionsEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: GroupDiscussionsView(isEmbedded: true)),
