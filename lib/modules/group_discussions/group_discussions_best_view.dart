...
import 'group_discussions_view.dart';

/// GroupDiscussionsBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:mesh / section:bento.
/// Wraps and preserves the original GroupDiscussionsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class GroupDiscussionsBestView extends StatelessWidget {
  const GroupDiscussionsBestView({super.key});
  ...
  static const Color _bgDark    = Color(0xFF030B22);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Group Discussions meaningful — clarified, named, and put to work in daily decisions.", Icons.handshake_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Group Discussions over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Group Discussions is alive in your life — not as theory, but as visible results.", Icons.public_rounded),
      _Pillar("Frontiers", "Where Group Discussions stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.handshake_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Group Discussions carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Group Discussions.",
      "Share an insight about Group Discussions with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Group Discussions.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Group Discussions is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Group Discussions', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.handshake_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.public_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When group discussions becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const GroupDiscussionsView()),
