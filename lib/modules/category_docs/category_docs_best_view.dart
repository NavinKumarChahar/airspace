...
import 'category_docs_view.dart';

/// CategoryDocsBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:beam / section:tabs.
/// Wraps and preserves the original CategoryDocsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class CategoryDocsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Category Docs meaningful — clarified, named, and put to work in daily decisions.", Icons.shield_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Category Docs over weeks, months and years.", Icons.workspace_premium_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Category Docs is alive in your life — not as theory, but as visible results.", Icons.spa_rounded),
      _Pillar("Frontiers", "Where Category Docs stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.shield_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Category Docs carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Category Docs.",
      "Share an insight about Category Docs with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Category Docs.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Category Docs is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Category Docs', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When category docs becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
