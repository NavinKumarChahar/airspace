...
import 'compitition_view.dart';

/// CompititionBestView
/// Auto-generated showcase view — Design Pattern: Rose / hero:beam / section:badges.
/// Wraps and preserves the original CompititionView at the bottom so no
...
class CompititionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Compitition meaningful — clarified, named, and put to work in daily decisions.", Icons.favorite_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Compitition over weeks, months and years.", Icons.workspace_premium_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Compitition is alive in your life — not as theory, but as visible results.", Icons.loyalty_rounded),
      _Pillar("Frontiers", "Where Compitition stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.favorite_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Compitition carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Compitition.",
      "Share an insight about Compitition with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Compitition.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Compitition is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Compitition', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When compitition becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const CompititionView()),
