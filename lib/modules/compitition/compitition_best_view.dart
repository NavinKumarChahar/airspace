...
import 'package:air_app/modules/compitition/compitition_enhanced_view.dart';
...
class CompititionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Compitition meaningful — clarified, named, and put to work in daily decisions.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Compitition over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Compitition is alive in your life — not as theory, but as visible results.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Compitition stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.favorite_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Compitition carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When compitition becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: CompititionEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: CompititionView(isEmbedded: true)),
