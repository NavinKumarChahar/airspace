...
import 'air_vision_view.dart';

/// AirVisionBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:grid / section:tabs.
/// Wraps and preserves the original AirVisionView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class AirVisionBestView extends StatelessWidget {
  const AirVisionBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Air Vision meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Air Vision over weeks, months and years.", Icons.bolt_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Air Vision is alive in your life — not as theory, but as visible results.", Icons.flare_rounded),
      _Pillar("Frontiers", "Where Air Vision stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Air Vision carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Air Vision.",
      "Share an insight about Air Vision with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Air Vision.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Air Vision is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Air Vision', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When air vision becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const AirVisionView()),
