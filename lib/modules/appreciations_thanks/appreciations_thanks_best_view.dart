...
class AppreciationsThanksBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Appreciations Thanks meaningful — clarified, named, and put to work in daily decisions.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Appreciations Thanks over weeks, months and years.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Appreciations Thanks is alive in your life — not as theory, but as visible results.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Appreciations Thanks stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.flare_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Appreciations Thanks carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Appreciations Thanks is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When appreciations thanks becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AppreciationsThanksView(isEmbedded: true)),
