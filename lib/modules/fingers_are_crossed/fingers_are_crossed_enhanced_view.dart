...
/// Auto-generated unique themed wrapper for Fingers Are Crossed.
/// Adds a fresh design + new content sections while preserving original content
/// (the original FingersAreCrossedView is embedded below the new sections).
///
/// Theme: Bronze Age | Layout: grid
class FingersAreCrossedEnhancedView extends StatelessWidget {
  final bool isEmbedded;
  const FingersAreCrossedEnhancedView({super.key, this.isEmbedded = false});
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Fingers Are Crossed',
                child: Text(
