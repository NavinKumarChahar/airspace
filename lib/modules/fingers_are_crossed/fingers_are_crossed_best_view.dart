...
import 'fingers_are_crossed_view.dart';

/// FingersAreCrossedBestView
/// Auto-generated showcase view — Design Pattern: Cyan / hero:beam / section:bento.
...
class FingersAreCrossedBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Fingers Are Crossed meaningful — clarified, named, and put to work in daily decisions.", Icons.diamond_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Fingers Are Crossed over weeks, months and years.", Icons.workspace_premium_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Fingers Are Crossed is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Fingers Are Crossed stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.diamond_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Fingers Are Crossed carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Fingers Are Crossed.",
      "Share an insight about Fingers Are Crossed with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Fingers Are Crossed.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Fingers Are Crossed is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Fingers Are Crossed', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When fingers are crossed becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const FingersAreCrossedView()),
