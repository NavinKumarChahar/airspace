...
import 'package:air_app/modules/fingers_are_crossed/fingers_are_crossed_enhanced_view.dart';
...
class FingersAreCrossedBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Fingers Are Crossed meaningful — clarified, named, and put to work in daily decisions.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Fingers Are Crossed over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Fingers Are Crossed is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Fingers Are Crossed stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.diamond_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Fingers Are Crossed carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Fingers Are Crossed is paired with reflection",
    ),
            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: _Quote(
                    text:
                        'When fingers are crossed becomes a practice rather than an idea, the whole story changes.',
                    primary: _primary,
                    secondary: _secondary,
                  ),
                ),
