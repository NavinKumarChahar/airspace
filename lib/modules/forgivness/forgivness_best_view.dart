...
import 'forgivness_view.dart';

/// ForgivnessBestView
/// Auto-generated showcase view — Design Pattern: Aurora / hero:beam / section:timeline.
/// Wraps and preserves the original ForgivnessView at the bottom so no
...
class ForgivnessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Forgivness meaningful — clarified, named, and put to work in daily decisions.", Icons.spa_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Forgivness over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Forgivness is alive in your life — not as theory, but as visible results.", Icons.loyalty_rounded),
      _Pillar("Frontiers", "Where Forgivness stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.spa_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Forgivness carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Forgivness.",
      "Share an insight about Forgivness with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Forgivness.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Forgivness is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Forgivness', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When forgivness becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ForgivnessView()),
