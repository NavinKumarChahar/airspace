...
import 'package:air_app/modules/forgivness/forgivness_enhanced_view.dart';
...
class ForgivnessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Forgivness meaningful — clarified, named, and put to work in daily decisions.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Forgivness over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Forgivness is alive in your life — not as theory, but as visible results.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Forgivness stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.spa_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Forgivness carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When forgivness becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: ForgivnessEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: ForgivnessView(isEmbedded: true)),
