...
class LifeHacksBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Life Hacks meaningful — clarified, named, and put to work in daily decisions.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Life Hacks over weeks, months and years.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Life Hacks is alive in your life — not as theory, but as visible results.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Life Hacks stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.handshake_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Life Hacks carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When life hacks becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: LifeHacksEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: LifeHacksView(isEmbedded: true)),
