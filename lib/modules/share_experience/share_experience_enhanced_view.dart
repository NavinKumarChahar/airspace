...
/// Auto-generated unique themed wrapper for Share Experience.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ShareExperienceView is embedded below the new sections).
///
/// Theme: Royal Plum | Layout: burst
class ShareExperienceEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ShareExperienceEnhancedView({
