...
import 'package:air_app/modules/share_experience/share_experience_enhanced_view.dart';
...
class ShareExperienceBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Share Experience meaningful — clarified, named, and put to work in daily decisions.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Share Experience over weeks, months and years.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Share Experience is alive in your life — not as theory, but as visible results.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Share Experience stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.workspace_premium_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Share Experience carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Share Experience is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When share experience becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: ShareExperienceEnhancedView(isEmbedded: true),
          ),
