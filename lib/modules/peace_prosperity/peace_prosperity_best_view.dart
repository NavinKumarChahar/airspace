...
import 'package:air_app/modules/peace_prosperity/peace_prosperity_enhanced_view.dart';
...
class PeaceProsperityBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Peace Prosperity meaningful — clarified, named, and put to work in daily decisions.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Peace Prosperity over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Peace Prosperity is alive in your life — not as theory, but as visible results.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Peace Prosperity stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.public_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Peace Prosperity carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Peace Prosperity is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When peace prosperity becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: PeaceProsperityEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: PeaceProsperityView(isEmbedded: true)),
