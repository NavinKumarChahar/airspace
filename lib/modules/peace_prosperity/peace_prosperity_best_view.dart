...
import 'peace_prosperity_view.dart';

/// PeaceProsperityBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:mesh / section:cards.
/// Wraps and preserves the original PeaceProsperityView at the bottom so no
...
class PeaceProsperityBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Peace Prosperity meaningful — clarified, named, and put to work in daily decisions.", Icons.public_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Peace Prosperity over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Peace Prosperity is alive in your life — not as theory, but as visible results.", Icons.celebration_rounded),
      _Pillar("Frontiers", "Where Peace Prosperity stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.public_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Peace Prosperity carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Peace Prosperity.",
      "Share an insight about Peace Prosperity with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Peace Prosperity.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Peace Prosperity is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Peace Prosperity', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When peace prosperity becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const PeaceProsperityView()),
