...
/// Auto-generated unique themed wrapper for Relationships.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RelationshipsView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: diagonal
class RelationshipsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RelationshipsEnhancedView({
