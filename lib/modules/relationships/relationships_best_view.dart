...
/// RelationshipsBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:mesh / section:tabs.
/// Wraps and preserves the original RelationshipsView at the bottom so no
...
class RelationshipsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Relationships meaningful — clarified, named, and put to work in daily decisions.", Icons.explore_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Relationships over weeks, months and years.", Icons.whatshot_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Relationships is alive in your life — not as theory, but as visible results.", Icons.celebration_rounded),
      _Pillar("Frontiers", "Where Relationships stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.explore_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Relationships carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Relationships.",
      "Share an insight about Relationships with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Relationships.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Relationships is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Relationships', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When relationships becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const RelationshipsView()),
