...
class RelationshipsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Relationships meaningful — clarified, named, and put to work in daily decisions.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Relationships over weeks, months and years.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Relationships is alive in your life — not as theory, but as visible results.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Relationships stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.explore_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Relationships carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Relationships is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When relationships becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: RelationshipsEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: RelationshipsView(isEmbedded: true)),
