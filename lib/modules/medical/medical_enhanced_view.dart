...
/// (the original MedicalView is embedded below the new sections).
///
/// Theme: Clay Earth | Layout: grid
class MedicalEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const MedicalEnhancedView({this.isEmbedded = false, required this.isDark});
