...
import 'package:air_app/modules/medical/medical_enhanced_view.dart';
...
class MedicalBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Medical meaningful — clarified, named, and put to work in daily decisions.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Medical over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Medical is alive in your life — not as theory, but as visible results.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Medical stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.forest_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Medical carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When medical becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: MedicalEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: MedicalView(isEmbedded: true)),
