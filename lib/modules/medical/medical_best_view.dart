...
/// MedicalBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:stripes / section:numbered.
/// Wraps and preserves the original MedicalView at the bottom so no
...
class MedicalBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Medical meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Medical over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Medical is alive in your life — not as theory, but as visible results.", Icons.workspace_premium_rounded),
      _Pillar("Frontiers", "Where Medical stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Medical carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Medical.",
      "Share an insight about Medical with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Medical.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Medical is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Medical', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When medical becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const MedicalView()),
