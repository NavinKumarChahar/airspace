...
import 'situation_reaction_view.dart';

/// SituationReactionBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:diagonal / section:numbered.
/// Wraps and preserves the original SituationReactionView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class SituationReactionBestView extends StatelessWidget {
  const SituationReactionBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Situation Reaction meaningful — clarified, named, and put to work in daily decisions.", Icons.whatshot_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Situation Reaction over weeks, months and years.", Icons.handshake_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Situation Reaction is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Situation Reaction stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.whatshot_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Situation Reaction carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Situation Reaction.",
      "Share an insight about Situation Reaction with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Situation Reaction.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Situation Reaction is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Situation Reaction', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.whatshot_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.handshake_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When situation reaction becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SituationReactionView()),
