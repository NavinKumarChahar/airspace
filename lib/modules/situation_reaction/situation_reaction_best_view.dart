...
import 'package:air_app/modules/situation_reaction/situation_reaction_enhanced_view.dart';
...
class SituationReactionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Situation Reaction meaningful — clarified, named, and put to work in daily decisions.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Situation Reaction over weeks, months and years.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Situation Reaction is alive in your life — not as theory, but as visible results.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Situation Reaction stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.whatshot_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Situation Reaction carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Situation Reaction is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When situation reaction becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: SituationReactionEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: SituationReactionView(isEmbedded: true)),
