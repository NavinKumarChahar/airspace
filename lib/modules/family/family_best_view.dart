...
class FamilyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Family meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Family over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Family is alive in your life — not as theory, but as visible results.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Family stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Family carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When family becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
