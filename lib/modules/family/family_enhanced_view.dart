...
/// Auto-generated unique themed wrapper for Family.
/// Adds a fresh design + new content sections while preserving original content
/// (the original FamilyView is embedded below the new sections).
///
/// Theme: Olive Grove | Layout: blocks
class FamilyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const FamilyEnhancedView({this.isEmbedded = false, required this.isDark});
