...
import 'success_failure_view.dart';

/// SuccessFailureBestView
/// Auto-generated showcase view — Design Pattern: Slate / hero:diagonal / section:gallery.
/// Wraps and preserves the original SuccessFailureView at the bottom so no
...
class SuccessFailureBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Success Failure meaningful — clarified, named, and put to work in daily decisions.", Icons.interests_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Success Failure over weeks, months and years.", Icons.explore_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Success Failure is alive in your life — not as theory, but as visible results.", Icons.handshake_rounded),
      _Pillar("Frontiers", "Where Success Failure stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.interests_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Success Failure carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Success Failure.",
      "Share an insight about Success Failure with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Success Failure.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Success Failure is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Success Failure', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When success failure becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SuccessFailureView()),
