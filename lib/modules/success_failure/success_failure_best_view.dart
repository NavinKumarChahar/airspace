...
class SuccessFailureBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Success Failure meaningful — clarified, named, and put to work in daily decisions.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Success Failure over weeks, months and years.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Success Failure is alive in your life — not as theory, but as visible results.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Success Failure stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.interests_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Success Failure carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Success Failure is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When success failure becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: SuccessFailureEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: SuccessFailureView(isEmbedded: true)),
