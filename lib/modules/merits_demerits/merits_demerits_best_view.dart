...
class MeritsDemeritsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Merits Demerits meaningful — clarified, named, and put to work in daily decisions.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Merits Demerits over weeks, months and years.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Merits Demerits is alive in your life — not as theory, but as visible results.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Merits Demerits stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.spa_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Merits Demerits carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Merits Demerits is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When merits demerits becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: MeritsDemeritsView(isEmbedded: true)),
