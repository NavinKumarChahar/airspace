...
/// Auto-generated unique themed wrapper for Merits Demerits.
/// Adds a fresh design + new content sections while preserving original content
/// (the original MeritsDemeritsView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: stripes
class MeritsDemeritsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const MeritsDemeritsEnhancedView({
