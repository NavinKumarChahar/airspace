...
class PracticeExpertiseBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Practice Expertise meaningful — clarified, named, and put to work in daily decisions.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Practice Expertise over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Practice Expertise is alive in your life — not as theory, but as visible results.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Practice Expertise stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.flag_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Practice Expertise carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Practice Expertise is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When practice expertise becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
