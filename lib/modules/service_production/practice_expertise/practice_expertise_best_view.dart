...
/// PracticeExpertiseBestView
/// Auto-generated showcase view — Design Pattern: Mint / hero:circles / section:cards.
/// Wraps and preserves the original PracticeExpertiseView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class PracticeExpertiseBestView extends StatelessWidget {
  const PracticeExpertiseBestView({super.key});

  static const Color _primary   = Color(0xFF14B8A6);
  static const Color _secondary = Color(0xFF0D9488);
  static const Color _accent    = Color(0xFFA7F3D0);
  static const Color _bgLight   = Color(0xFFF0FDFA);
  static const Color _bgDark    = Color(0xFF03161B);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Practice Expertise meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Practice Expertise over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Practice Expertise is alive in your life — not as theory, but as visible results.", Icons.star_rounded),
      _Pillar("Frontiers", "Where Practice Expertise stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Practice Expertise carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Practice Expertise.",
      "Share an insight about Practice Expertise with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Practice Expertise.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Practice Expertise is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Practice Expertise', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When practice expertise becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const PracticeExpertiseView()),
