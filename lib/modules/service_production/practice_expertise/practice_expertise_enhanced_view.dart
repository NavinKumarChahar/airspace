...
/// Auto-generated unique themed wrapper for Practice Expertise.
/// Adds a fresh design + new content sections while preserving original content
/// (the original PracticeExpertiseView is embedded below the new sections).
///
/// Theme: Coral Reef | Layout: stripes
class PracticeExpertiseEnhancedView extends StatelessWidget {
  const PracticeExpertiseEnhancedView({super.key});
  ...
  static const Color _soft = Color(0xffffe4e6);
  static const Color _gold = Color(0xff06b6d4);
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Practice Expertise',
                child: Text(
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              ...
              child: const PracticeExpertiseView(),
            ),
          ),
        ],
      ),
