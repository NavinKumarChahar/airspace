...
/// Auto-generated unique themed wrapper for System All Together.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SystemAllTogetherView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: wave
class SystemAllTogetherEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SystemAllTogetherEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About System All Together',
          child: Text(
