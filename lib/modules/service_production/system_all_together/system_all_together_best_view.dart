...
import 'system_all_together_view.dart';

/// SystemAllTogetherBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:orb / section:badges.
/// Wraps and preserves the original SystemAllTogetherView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class SystemAllTogetherBestView extends StatelessWidget {
  const SystemAllTogetherBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make System All Together meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of System All Together over weeks, months and years.", Icons.loyalty_rounded),
      _Pillar("Outcomes", "Tangible markers that prove System All Together is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where System All Together stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch System All Together carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of System All Together.",
      "Share an insight about System All Together with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on System All Together.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when System All Together is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'System All Together', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When system all together becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SystemAllTogetherView()),
