...
/// Auto-generated unique themed wrapper for Process.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ProcessView is embedded below the new sections).
///
/// Theme: Magenta Pulse | Layout: circles
class ProcessEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ProcessEnhancedView({this.isEmbedded = false, required this.isDark});
