...
/// ProcessBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:grid / section:timeline.
/// Wraps and preserves the original ProcessView at the bottom so no
...
class ProcessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Process meaningful — clarified, named, and put to work in daily decisions.", Icons.lightbulb_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Process over weeks, months and years.", Icons.lightbulb_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Process is alive in your life — not as theory, but as visible results.", Icons.shield_rounded),
      _Pillar("Frontiers", "Where Process stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.lightbulb_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Process carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Process.",
      "Share an insight about Process with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Process.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Process is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Process', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When process becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ProcessView()),
