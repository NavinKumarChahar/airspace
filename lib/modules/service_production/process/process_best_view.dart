...
import 'package:air_app/modules/service_production/process/process_enhanced_view.dart';
...
class ProcessBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Process meaningful — clarified, named, and put to work in daily decisions.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Process over weeks, months and years.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Process is alive in your life — not as theory, but as visible results.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Process stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.lightbulb_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Process carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When process becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
