...
/// Auto-generated unique themed wrapper for Input In Process.
/// Adds a fresh design + new content sections while preserving original content
/// (the original InputInProcessView is embedded below the new sections).
///
/// Theme: Olive Grove | Layout: stripes
class InputInProcessEnhancedView extends StatelessWidget {
  const InputInProcessEnhancedView({super.key});

  static const Color _bg = Color(0xff1a1f0a);
  static const Color _bg2 = Color(0xff2e380f);
  static const Color _accent = Color(0xff65a30d);
  static const Color _soft = Color(0xffd9f99d);
        ...
        slivers: [
              ...
              child: _Section(
                ...
                child: Column(
                  children: [
                    _Step(
                      n: 1,
                      text: 'Pick one habit to refine',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 2,
                      text: 'Reduce its friction by half',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 3,
                      text: 'Practice for seven days',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 4,
                      text: 'Reflect on the seventh evening',
                      accent: _accent,
                      gold: _gold,
                    ),
                  ],
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              ...
              child: const InputInProcessView(),
            ),
          ),
        ],
      ),
