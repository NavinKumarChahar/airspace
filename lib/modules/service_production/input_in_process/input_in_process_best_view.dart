...
import 'input_in_process_view.dart';

/// InputInProcessBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:beam / section:timeline.
/// Wraps and preserves the original InputInProcessView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class InputInProcessBestView extends StatelessWidget {
  const InputInProcessBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Input In Process meaningful — clarified, named, and put to work in daily decisions.", Icons.favorite_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Input In Process over weeks, months and years.", Icons.explore_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Input In Process is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Input In Process stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.favorite_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Input In Process carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Input In Process.",
      "Share an insight about Input In Process with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Input In Process.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Input In Process is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Input In Process', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.explore_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When input in process becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const InputInProcessView()),
