...
import 'outcome_processed_view.dart';

/// OutcomeProcessedBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:wave / section:accordion.
/// Wraps and preserves the original OutcomeProcessedView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class OutcomeProcessedBestView extends StatelessWidget {
  const OutcomeProcessedBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Outcome Processed meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Outcome Processed over weeks, months and years.", Icons.bolt_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Outcome Processed is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Outcome Processed stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Outcome Processed carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Outcome Processed.",
      "Share an insight about Outcome Processed with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Outcome Processed.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Outcome Processed is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroWave(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Outcome Processed', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When outcome processed becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
