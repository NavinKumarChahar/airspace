...
/// Auto-generated unique themed wrapper for Outcome Processed.
/// Adds a fresh design + new content sections while preserving original content
/// (the original OutcomeProcessedView is embedded below the new sections).
///
/// Theme: Ember Forge | Layout: diagonal
class OutcomeProcessedEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const OutcomeProcessedEnhancedView({
