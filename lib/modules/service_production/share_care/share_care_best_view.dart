...
class ShareCareBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Share Care meaningful — clarified, named, and put to work in daily decisions.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Share Care over weeks, months and years.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Share Care is alive in your life — not as theory, but as visible results.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Share Care stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.public_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Share Care carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When share care becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
