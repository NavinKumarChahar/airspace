...
/// ShareCareBestView
/// Auto-generated showcase view — Design Pattern: Royal / hero:spiral / section:bento.
/// Wraps and preserves the original ShareCareView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ShareCareBestView extends StatelessWidget {
  const ShareCareBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Share Care meaningful — clarified, named, and put to work in daily decisions.", Icons.public_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Share Care over weeks, months and years.", Icons.star_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Share Care is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Share Care stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.public_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Share Care carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Share Care.",
      "Share an insight about Share Care with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Share Care.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Share Care is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Share Care', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When share care becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ShareCareView()),
