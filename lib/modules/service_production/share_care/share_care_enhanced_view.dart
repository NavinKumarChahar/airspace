...
/// Auto-generated unique themed wrapper for Share Care.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ShareCareView is embedded below the new sections).
///
/// Theme: Ember Forge | Layout: grid
class ShareCareEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ShareCareEnhancedView({this.isEmbedded = false, required this.isDark});
