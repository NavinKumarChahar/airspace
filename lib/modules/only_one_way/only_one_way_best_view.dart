...
import 'only_one_way_view.dart';

/// OnlyOneWayBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:grid / section:cards.
/// Wraps and preserves the original OnlyOneWayView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class OnlyOneWayBestView extends StatelessWidget {
  const OnlyOneWayBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Only One Way meaningful — clarified, named, and put to work in daily decisions.", Icons.workspace_premium_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Only One Way over weeks, months and years.", Icons.loyalty_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Only One Way is alive in your life — not as theory, but as visible results.", Icons.whatshot_rounded),
      _Pillar("Frontiers", "Where Only One Way stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.workspace_premium_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Only One Way carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Only One Way.",
      "Share an insight about Only One Way with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Only One Way.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Only One Way is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Only One Way', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When only one way becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const OnlyOneWayView()),
