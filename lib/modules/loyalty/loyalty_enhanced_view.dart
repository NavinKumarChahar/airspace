...
/// Auto-generated unique themed wrapper for Loyalty.
/// Adds a fresh design + new content sections while preserving original content
/// (the original LoyaltyView is embedded below the new sections).
///
/// Theme: Coral Reef | Layout: blocks
class LoyaltyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const LoyaltyEnhancedView({this.isEmbedded = false, required this.isDark});
