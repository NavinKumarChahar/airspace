...
/// LoyaltyBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:circles / section:split.
/// Wraps and preserves the original LoyaltyView at the bottom so no
...
class LoyaltyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Loyalty meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Loyalty over weeks, months and years.", Icons.auto_awesome_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Loyalty is alive in your life — not as theory, but as visible results.", Icons.rocket_launch_rounded),
      _Pillar("Frontiers", "Where Loyalty stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Loyalty carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Loyalty.",
      "Share an insight about Loyalty with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Loyalty.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Loyalty is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Loyalty', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When loyalty becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const LoyaltyView()),
