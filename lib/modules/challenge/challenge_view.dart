    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'We believe challenges are opportunities for growth. '
            'Explore the key hurdles we face and how we plan to conquer them.',
            style: TextStyle(
              fontSize: 14,
...
final List<_Section> _sections = [
  ...
  _Section(
    ...
    color: Colors.indigo,
    points: [
      'Maintaining uptime standards.',
      'Bug resolution prioritization.',
