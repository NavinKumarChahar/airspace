...
/// ChallengeBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:grid / section:gallery.
/// Wraps and preserves the original ChallengeView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ChallengeBestView extends StatelessWidget {
  const ChallengeBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Challenge meaningful — clarified, named, and put to work in daily decisions.", Icons.interests_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Challenge over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Challenge is alive in your life — not as theory, but as visible results.", Icons.public_rounded),
      _Pillar("Frontiers", "Where Challenge stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.interests_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Challenge carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Challenge.",
      "Share an insight about Challenge with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Challenge.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Challenge is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Challenge', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When challenge becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ChallengeView()),
