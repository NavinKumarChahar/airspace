...
class ChallengeBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Challenge meaningful — clarified, named, and put to work in daily decisions.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Challenge over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Challenge is alive in your life — not as theory, but as visible results.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Challenge stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.interests_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Challenge carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When challenge becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: ChallengeView(isEmbedded: true)),
