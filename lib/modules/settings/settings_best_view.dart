...
/// SettingsBestView
/// Auto-generated showcase view — Design Pattern: Rose / hero:diagonal / section:stats.
/// Wraps and preserves the original SettingsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class SettingsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Settings meaningful — clarified, named, and put to work in daily decisions.", Icons.interests_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Settings over weeks, months and years.", Icons.public_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Settings is alive in your life — not as theory, but as visible results.", Icons.star_rounded),
      _Pillar("Frontiers", "Where Settings stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.interests_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Settings carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Settings.",
      "Share an insight about Settings with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Settings.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Settings is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Settings', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When settings becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SettingsView()),
