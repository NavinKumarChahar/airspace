...
/// Auto-generated unique themed wrapper for Settings.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SettingsView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: diagonal
class SettingsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SettingsEnhancedView({this.isEmbedded = false, required this.isDark});
