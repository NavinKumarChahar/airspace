...
/// Auto-generated unique themed wrapper for Record Post.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RecordPostView is embedded below the new sections).
///
/// Theme: Coral Reef | Layout: grid
class RecordPostEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RecordPostEnhancedView({this.isEmbedded = false, required this.isDark});
