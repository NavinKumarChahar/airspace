...
class RecordPostBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Record Post meaningful — clarified, named, and put to work in daily decisions.", Icons.explore_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Record Post over weeks, months and years.", Icons.auto_awesome_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Record Post is alive in your life — not as theory, but as visible results.", Icons.loyalty_rounded),
      _Pillar("Frontiers", "Where Record Post stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.explore_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Record Post carefully without rushing to judgement. The first move is noticing."),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Record Post', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When record post becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const RecordPostView()),
