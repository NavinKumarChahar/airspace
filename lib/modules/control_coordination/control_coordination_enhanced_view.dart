...
/// Auto-generated unique themed wrapper for Control Coordination.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ControlCoordinationView is embedded below the new sections).
///
/// Theme: Royal Plum | Layout: burst
class ControlCoordinationEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ControlCoordinationEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Control Coordination',
          child: Text(
