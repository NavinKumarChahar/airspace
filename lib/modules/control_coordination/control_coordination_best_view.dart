...
import 'control_coordination_view.dart';

/// ControlCoordinationBestView
/// Auto-generated showcase view — Design Pattern: Emerald / hero:mesh / section:cards.
/// Wraps and preserves the original ControlCoordinationView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ControlCoordinationBestView extends StatelessWidget {
  const ControlCoordinationBestView({super.key});
  ...
  static const Color _bgDark    = Color(0xFF021509);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Control Coordination meaningful — clarified, named, and put to work in daily decisions.", Icons.grain_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Control Coordination over weeks, months and years.", Icons.celebration_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Control Coordination is alive in your life — not as theory, but as visible results.", Icons.shield_rounded),
      _Pillar("Frontiers", "Where Control Coordination stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.grain_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Control Coordination carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Control Coordination.",
      "Share an insight about Control Coordination with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Control Coordination.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Control Coordination is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroMesh(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Control Coordination', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.celebration_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.shield_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When control coordination becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ControlCoordinationView()),
