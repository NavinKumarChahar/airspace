...
import 'category_tree_view.dart';

/// CategoryTreeBestView
/// Auto-generated showcase view — Design Pattern: Cyan / hero:diagonal / section:cards.
/// Wraps and preserves the original CategoryTreeView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class CategoryTreeBestView extends StatelessWidget {
  const CategoryTreeBestView({super.key});
  ...
  static const Color _bgLight   = Color(0xFFECFEFF);
  static const Color _bgDark    = Color(0xFF021622);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Category Tree meaningful — clarified, named, and put to work in daily decisions.", Icons.interests_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Category Tree over weeks, months and years.", Icons.celebration_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Category Tree is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Category Tree stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.interests_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Category Tree carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Category Tree.",
      "Share an insight about Category Tree with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Category Tree.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Category Tree is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Category Tree', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.interests_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When category tree becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const CategoryTreeView()),
