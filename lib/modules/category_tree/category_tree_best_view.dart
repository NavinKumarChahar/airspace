...
class CategoryTreeBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Category Tree meaningful — clarified, named, and put to work in daily decisions.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Category Tree over weeks, months and years.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Category Tree is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Category Tree stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.interests_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Category Tree carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Category Tree is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When category tree becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: CategoryTreeView(isEmbedded: true)),
