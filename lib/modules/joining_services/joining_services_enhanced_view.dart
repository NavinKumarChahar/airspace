...
/// Auto-generated unique themed wrapper for Joining Services.
/// Adds a fresh design + new content sections while preserving original content
/// (the original JoiningServicesView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: diagonal
class JoiningServicesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const JoiningServicesEnhancedView({
