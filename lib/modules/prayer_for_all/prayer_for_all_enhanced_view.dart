...
/// Auto-generated unique themed wrapper for Prayer For All.
/// Adds a fresh design + new content sections while preserving original content
/// (the original PrayerForAllView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: rings
class PrayerForAllEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const PrayerForAllEnhancedView({
