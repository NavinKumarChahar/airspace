...
class PrayerForAllBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Prayer For All meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Prayer For All over weeks, months and years.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Prayer For All is alive in your life — not as theory, but as visible results.",
      Icons.insights_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Prayer For All stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Prayer For All carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Prayer For All is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When prayer for all becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
