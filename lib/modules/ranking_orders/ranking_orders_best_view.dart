...
import 'ranking_orders_view.dart';

/// RankingOrdersBestView
/// Auto-generated showcase view — Design Pattern: Slate / hero:stripes / section:tabs.
/// Wraps and preserves the original RankingOrdersView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class RankingOrdersBestView extends StatelessWidget {
  const RankingOrdersBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Ranking Orders meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Ranking Orders over weeks, months and years.", Icons.workspace_premium_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Ranking Orders is alive in your life — not as theory, but as visible results.", Icons.celebration_rounded),
      _Pillar("Frontiers", "Where Ranking Orders stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Ranking Orders carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Ranking Orders.",
      "Share an insight about Ranking Orders with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Ranking Orders.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Ranking Orders is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Ranking Orders', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.workspace_premium_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.celebration_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When ranking orders becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const RankingOrdersView()),
