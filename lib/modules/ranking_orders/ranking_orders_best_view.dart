...
import 'package:air_app/modules/ranking_orders/ranking_orders_enhanced_view.dart';
...
class RankingOrdersBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Ranking Orders meaningful — clarified, named, and put to work in daily decisions.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Ranking Orders over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Ranking Orders is alive in your life — not as theory, but as visible results.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Ranking Orders stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.flag_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Ranking Orders carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Ranking Orders is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When ranking orders becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: RankingOrdersEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: RankingOrdersView(isEmbedded: true)),
