...
import 'package:air_app/modules/products_services/products_services_enhanced_view.dart';
...
class ProductsServicesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Products Services meaningful — clarified, named, and put to work in daily decisions.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Products Services over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Products Services is alive in your life — not as theory, but as visible results.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Products Services stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.diamond_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Products Services carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Products Services is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When products services becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: ProductsServicesEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: ProductsServicesView(isEmbedded: true)),
