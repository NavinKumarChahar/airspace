...
import 'knowledge_center_view.dart';

/// KnowledgeCenterBestView
/// Auto-generated showcase view — Design Pattern: Indigo / hero:spiral / section:timeline.
/// Wraps and preserves the original KnowledgeCenterView at the bottom so no
...
class KnowledgeCenterBestView extends StatelessWidget {
  ...
  static const Color _bgLight   = Color(0xFFEEF2FF);
  static const Color _bgDark    = Color(0xFF080720);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Knowledge Center meaningful — clarified, named, and put to work in daily decisions.", Icons.explore_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Knowledge Center over weeks, months and years.", Icons.rocket_launch_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Knowledge Center is alive in your life — not as theory, but as visible results.", Icons.explore_rounded),
      _Pillar("Frontiers", "Where Knowledge Center stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.explore_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Knowledge Center carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Knowledge Center.",
      "Share an insight about Knowledge Center with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Knowledge Center.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Knowledge Center is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Knowledge Center', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.explore_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When knowledge center becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const KnowledgeCenterView()),
