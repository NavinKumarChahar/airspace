...
import 'package:air_app/modules/trade_import_export/trade_import_export_enhanced_view.dart';
...
class TradeImportExportBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Trade Import Export meaningful — clarified, named, and put to work in daily decisions.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Trade Import Export over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Trade Import Export is alive in your life — not as theory, but as visible results.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Trade Import Export stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.lightbulb_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Trade Import Export carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Trade Import Export is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When trade import export becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
