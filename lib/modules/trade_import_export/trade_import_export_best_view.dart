...
import 'trade_import_export_view.dart';

/// TradeImportExportBestView
/// Auto-generated showcase view — Design Pattern: Coral / hero:diagonal / section:gallery.
/// Wraps and preserves the original TradeImportExportView at the bottom so no
...
class TradeImportExportBestView extends StatelessWidget {
  ...
  static const Color _bgDark    = Color(0xFF1A0610);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Trade Import Export meaningful — clarified, named, and put to work in daily decisions.", Icons.lightbulb_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Trade Import Export over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Trade Import Export is alive in your life — not as theory, but as visible results.", Icons.auto_awesome_rounded),
      _Pillar("Frontiers", "Where Trade Import Export stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.lightbulb_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Trade Import Export carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Trade Import Export.",
      "Share an insight about Trade Import Export with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Trade Import Export.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Trade Import Export is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Trade Import Export', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.lightbulb_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When trade import export becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
