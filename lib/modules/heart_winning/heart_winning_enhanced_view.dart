...
/// Auto-generated unique themed wrapper for Heart Winning.
/// Adds a fresh design + new content sections while preserving original content
/// (the original HeartWinningView is embedded below the new sections).
///
/// Theme: Aurora Teal | Layout: blocks
class HeartWinningEnhancedView extends StatelessWidget {
  const HeartWinningEnhancedView({super.key});
  ...
  static const Color _soft = Color(0xffa7f3d0);
  static const Color _gold = Color(0xffa855f7);
              ...
              child: _Section(
                ...
                child: Column(
                  children: [
                    _Pillar(
                      n: 1,
                      text: 'Listen first, twice',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Pillar(
                      n: 2,
                      text: 'Decide once, fully',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Pillar(
                      n: 3,
                      text: 'Move slow, then fast',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Pillar(
                      n: 4,
                      text: 'Reflect, then repeat',
                      accent: _accent,
                      gold: _gold,
                    ),
                  ],
              ...
              child: _Section(
                ...
                child: Column(
                  children: [
                    _Step(
                      n: 1,
                      text: 'Write the question you\'re avoiding',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 2,
                      text: 'Sit with it without solving',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 3,
                      text: 'Ask a wiser version of yourself',
                      accent: _accent,
                      gold: _gold,
                    ),
                    _Step(
                      n: 4,
                      text: 'Take the smallest brave step',
                      accent: _accent,
                      gold: _gold,
                    ),
                  ],
