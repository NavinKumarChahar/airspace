...
import 'heart_winning_view.dart';

/// HeartWinningBestView
/// Auto-generated showcase view — Design Pattern: Crimson / hero:circles / section:numbered.
/// Wraps and preserves the original HeartWinningView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class HeartWinningBestView extends StatelessWidget {
  const HeartWinningBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Heart Winning meaningful — clarified, named, and put to work in daily decisions.", Icons.insights_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Heart Winning over weeks, months and years.", Icons.insights_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Heart Winning is alive in your life — not as theory, but as visible results.", Icons.shield_rounded),
      _Pillar("Frontiers", "Where Heart Winning stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.insights_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Heart Winning carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Heart Winning.",
      "Share an insight about Heart Winning with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Heart Winning.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Heart Winning is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Heart Winning', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When heart winning becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const HeartWinningView()),
