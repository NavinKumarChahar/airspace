...
class IdentityBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Identity meaningful — clarified, named, and put to work in daily decisions.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Identity over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Identity is alive in your life — not as theory, but as visible results.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Identity stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.favorite_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Identity carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When identity becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: IdentityView(isEmbedded: true)),
