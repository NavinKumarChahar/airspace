...
import 'package:air_app/modules/universal_peace_rule/universal_peace_rule_enhanced_view.dart';
...
class UniversalPeaceRuleBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Universal Peace Rule meaningful — clarified, named, and put to work in daily decisions.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Universal Peace Rule over weeks, months and years.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Universal Peace Rule is alive in your life — not as theory, but as visible results.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Universal Peace Rule stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.bolt_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Universal Peace Rule carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Universal Peace Rule is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When universal peace rule becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: UniversalPeaceRuleEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: UniversalPeaceRuleView(isEmbedded: true)),
