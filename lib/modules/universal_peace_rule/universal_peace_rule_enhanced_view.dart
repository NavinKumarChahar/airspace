...
/// Auto-generated unique themed wrapper for Universal Peace Rule.
/// Adds a fresh design + new content sections while preserving original content
/// (the original UniversalPeaceRuleView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: stripes
class UniversalPeaceRuleEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const UniversalPeaceRuleEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Universal Peace Rule',
          child: Text(
