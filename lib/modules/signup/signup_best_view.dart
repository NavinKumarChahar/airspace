...
class SignupBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Signup meaningful — clarified, named, and put to work in daily decisions.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Signup over weeks, months and years.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Signup is alive in your life — not as theory, but as visible results.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Signup stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.workspace_premium_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Signup carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When signup becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: SignupEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: SignupView(isEmbedded: true)),
