...
/// SignupBestView
/// Auto-generated showcase view — Design Pattern: Steel / hero:orb / section:gallery.
/// Wraps and preserves the original SignupView at the bottom so no
...
class SignupBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Signup meaningful — clarified, named, and put to work in daily decisions.", Icons.workspace_premium_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Signup over weeks, months and years.", Icons.grain_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Signup is alive in your life — not as theory, but as visible results.", Icons.lightbulb_rounded),
      _Pillar("Frontiers", "Where Signup stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.workspace_premium_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Signup carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Signup.",
      "Share an insight about Signup with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Signup.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Signup is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Signup', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When signup becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SignupView()),
