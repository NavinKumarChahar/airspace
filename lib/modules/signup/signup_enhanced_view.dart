...
/// Auto-generated unique themed wrapper for Signup.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SignupView is embedded below the new sections).
///
/// Theme: Bronze Age | Layout: burst
class SignupEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SignupEnhancedView({this.isEmbedded = false, required this.isDark});
