...
/// Auto-generated unique themed wrapper for Identities Earnings.
/// Adds a fresh design + new content sections while preserving original content
/// (the original IdentitiesEarningsView is embedded below the new sections).
///
/// Theme: Slate Steel | Layout: burst
class IdentitiesEarningsEnhancedView extends StatelessWidget {
  const IdentitiesEarningsEnhancedView({super.key});
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Identities Earnings',
                child: Text(
          ...
          SliverToBoxAdapter(
            child: SizedBox(
              ...
              child: const IdentitiesEarningsView(),
            ),
          ),
        ],
      ),
