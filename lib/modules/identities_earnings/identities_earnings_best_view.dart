...
import 'identities_earnings_view.dart';

/// IdentitiesEarningsBestView
/// Auto-generated showcase view — Design Pattern: Bronze / hero:prism / section:badges.
/// Wraps and preserves the original IdentitiesEarningsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class IdentitiesEarningsBestView extends StatelessWidget {
  const IdentitiesEarningsBestView({super.key});
  ...
  static const Color _bgLight   = Color(0xFFFFFBEB);
  static const Color _bgDark    = Color(0xFF1A0E03);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Identities Earnings meaningful — clarified, named, and put to work in daily decisions.", Icons.auto_awesome_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Identities Earnings over weeks, months and years.", Icons.favorite_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Identities Earnings is alive in your life — not as theory, but as visible results.", Icons.explore_rounded),
      _Pillar("Frontiers", "Where Identities Earnings stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.auto_awesome_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Identities Earnings carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Identities Earnings.",
      "Share an insight about Identities Earnings with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Identities Earnings.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Identities Earnings is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Identities Earnings', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.auto_awesome_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When identities earnings becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const IdentitiesEarningsView()),
