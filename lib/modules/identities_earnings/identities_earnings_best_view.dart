...
import 'package:air_app/modules/identities_earnings/identities_earnings_enhanced_view.dart';
...
class IdentitiesEarningsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Identities Earnings meaningful — clarified, named, and put to work in daily decisions.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Identities Earnings over weeks, months and years.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Identities Earnings is alive in your life — not as theory, but as visible results.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Identities Earnings stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.auto_awesome_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Identities Earnings carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Identities Earnings is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When identities earnings becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: IdentitiesEarningsEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: IdentitiesEarningsView(isEmbedded: true)),
