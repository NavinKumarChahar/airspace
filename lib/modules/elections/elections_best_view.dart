...
import 'elections_view.dart';

/// ElectionsBestView
/// Auto-generated showcase view — Design Pattern: Emerald / hero:mesh / section:timeline.
/// Wraps and preserves the original ElectionsView at the bottom so no
...
class ElectionsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Elections meaningful — clarified, named, and put to work in daily decisions.", Icons.loyalty_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Elections over weeks, months and years.", Icons.celebration_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Elections is alive in your life — not as theory, but as visible results.", Icons.flag_rounded),
      _Pillar("Frontiers", "Where Elections stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.loyalty_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Elections carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Elections.",
      "Share an insight about Elections with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Elections.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Elections is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Elections', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When elections becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ElectionsView()),
