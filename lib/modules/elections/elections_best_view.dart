...
import 'package:air_app/modules/elections/elections_enhanced_view.dart';
...
class ElectionsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Elections meaningful — clarified, named, and put to work in daily decisions.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Elections over weeks, months and years.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Elections is alive in your life — not as theory, but as visible results.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Elections stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.loyalty_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Elections carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When elections becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: ElectionsEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: ElectionsView(isEmbedded: true)),
