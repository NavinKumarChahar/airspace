...
/// Auto-generated unique themed wrapper for Elections.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ElectionsView is embedded below the new sections).
///
/// Theme: Clay Earth | Layout: burst
class ElectionsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ElectionsEnhancedView({this.isEmbedded = false, required this.isDark});
