...
/// (the original TechnologyView is embedded below the new sections).
///
/// Theme: Mint Spring | Layout: blocks
class TechnologyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const TechnologyEnhancedView({this.isEmbedded = false, required this.isDark});
