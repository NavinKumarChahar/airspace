...
/// TechnologyBestView
/// Auto-generated showcase view — Design Pattern: Bronze / hero:mesh / section:gallery.
/// Wraps and preserves the original TechnologyView at the bottom so no
...
class TechnologyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Technology meaningful — clarified, named, and put to work in daily decisions.", Icons.loyalty_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Technology over weeks, months and years.", Icons.celebration_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Technology is alive in your life — not as theory, but as visible results.", Icons.flag_rounded),
      _Pillar("Frontiers", "Where Technology stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.loyalty_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Technology carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Technology.",
      "Share an insight about Technology with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Technology.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Technology is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Technology', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When technology becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const TechnologyView()),
