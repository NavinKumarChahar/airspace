...
class DiscoveryBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Discovery meaningful — clarified, named, and put to work in daily decisions.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Discovery over weeks, months and years.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Discovery is alive in your life — not as theory, but as visible results.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Discovery stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.local_fire_department_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Discovery carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When discovery becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
