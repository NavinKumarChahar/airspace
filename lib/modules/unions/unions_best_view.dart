...
import 'unions_view.dart';

/// UnionsBestView
/// Auto-generated showcase view — Design Pattern: Crimson / hero:wave / section:numbered.
/// Wraps and preserves the original UnionsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class UnionsBestView extends StatelessWidget {
  const UnionsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Unions meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Unions over weeks, months and years.", Icons.diamond_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Unions is alive in your life — not as theory, but as visible results.", Icons.handshake_rounded),
      _Pillar("Frontiers", "Where Unions stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Unions carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Unions.",
      "Share an insight about Unions with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Unions.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Unions is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Unions', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.diamond_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When unions becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const UnionsView()),
