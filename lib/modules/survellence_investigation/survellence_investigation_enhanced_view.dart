...
/// Auto-generated unique themed wrapper for Survellence Investigation.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SurvellenceInvestigationView is embedded below the new sections).
///
/// Theme: Royal Plum | Layout: circles
class SurvellenceInvestigationEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SurvellenceInvestigationEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Survellence Investigation',
          child: Text(
