...
import 'survellence_investigation_view.dart';

/// SurvellenceInvestigationBestView
/// Auto-generated showcase view — Design Pattern: Magenta / hero:orb / section:tabs.
/// Wraps and preserves the original SurvellenceInvestigationView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class SurvellenceInvestigationBestView extends StatelessWidget {
  const SurvellenceInvestigationBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Survellence Investigation meaningful — clarified, named, and put to work in daily decisions.", Icons.rocket_launch_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Survellence Investigation over weeks, months and years.", Icons.rocket_launch_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Survellence Investigation is alive in your life — not as theory, but as visible results.", Icons.grain_rounded),
      _Pillar("Frontiers", "Where Survellence Investigation stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.rocket_launch_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Survellence Investigation carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Survellence Investigation.",
      "Share an insight about Survellence Investigation with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Survellence Investigation.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Survellence Investigation is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroOrb(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Survellence Investigation', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.rocket_launch_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 24),
              child: _TabsBlock(steps: _steps, primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.rocket_launch_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.grain_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When survellence investigation becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const SurvellenceInvestigationView()),
