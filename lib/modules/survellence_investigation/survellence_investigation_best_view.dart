...
import 'package:air_app/modules/survellence_investigation/survellence_investigation_enhanced_view.dart';
...
class SurvellenceInvestigationBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Survellence Investigation meaningful — clarified, named, and put to work in daily decisions.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Survellence Investigation over weeks, months and years.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Survellence Investigation is alive in your life — not as theory, but as visible results.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Survellence Investigation stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.rocket_launch_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Survellence Investigation carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Survellence Investigation is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When survellence investigation becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
