...
class AdvantageBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Advantage meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Advantage over weeks, months and years.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Advantage is alive in your life — not as theory, but as visible results.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Advantage stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Advantage carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When advantage becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AdvantageView(isEmbedded: true)),
