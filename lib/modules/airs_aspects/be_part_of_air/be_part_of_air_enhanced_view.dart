...
/// Auto-generated unique themed wrapper for Be Part Of Air.
/// Adds a fresh design + new content sections while preserving original content
/// (the original BePartOfAirView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: burst
class BePartOfAirEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const BePartOfAirEnhancedView({
