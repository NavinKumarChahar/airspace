...
/// BePartOfAirBestView
/// Auto-generated showcase view — Design Pattern: Rose / hero:spiral / section:accordion.
...
class BePartOfAirBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Be Part Of Air meaningful — clarified, named, and put to work in daily decisions.", Icons.psychology_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Be Part Of Air over weeks, months and years.", Icons.grain_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Be Part Of Air is alive in your life — not as theory, but as visible results.", Icons.flag_rounded),
      _Pillar("Frontiers", "Where Be Part Of Air stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.psychology_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Be Part Of Air carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Be Part Of Air.",
      "Share an insight about Be Part Of Air with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Be Part Of Air.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Be Part Of Air is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Be Part Of Air', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When be part of air becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const BePartOfAirView()),
