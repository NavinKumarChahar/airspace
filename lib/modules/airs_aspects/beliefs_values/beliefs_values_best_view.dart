...
import 'beliefs_values_view.dart';

/// BeliefsValuesBestView
/// Auto-generated showcase view — Design Pattern: Mint / hero:mesh / section:stats.
/// Wraps and preserves the original BeliefsValuesView at the bottom so no
...
class BeliefsValuesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Beliefs Values meaningful — clarified, named, and put to work in daily decisions.", Icons.shield_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Beliefs Values over weeks, months and years.", Icons.forest_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Beliefs Values is alive in your life — not as theory, but as visible results.", Icons.auto_awesome_rounded),
      _Pillar("Frontiers", "Where Beliefs Values stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.shield_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Beliefs Values carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Beliefs Values.",
      "Share an insight about Beliefs Values with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Beliefs Values.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Beliefs Values is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Beliefs Values', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When beliefs values becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
