...
import 'package:air_app/modules/airs_aspects/beliefs_values/beliefs_values_enhanced_view.dart';
...
class BeliefsValuesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Beliefs Values meaningful — clarified, named, and put to work in daily decisions.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Beliefs Values over weeks, months and years.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Beliefs Values is alive in your life — not as theory, but as visible results.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Beliefs Values stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.shield_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Beliefs Values carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Beliefs Values is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When beliefs values becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: BeliefsValuesEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: BeliefsValuesView(isEmbedded: true)),
