...
import 'package:air_app/modules/airs_aspects/contribute_to_air/contribute_to_air_enhanced_view.dart';
...
class ContributeToAirBestView extends StatelessWidget {
  ...
  const ContributeToAirBestView({super.key, this.isEmbedded = false});
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Contribute To Air meaningful — clarified, named, and put to work in daily decisions.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Contribute To Air over weeks, months and years.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Contribute To Air is alive in your life — not as theory, but as visible results.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Contribute To Air stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.psychology_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Contribute To Air carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Contribute To Air is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When contribute to air becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: ContributeToAirEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: ContributeToAirView()),
