...
/// Limits01BestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:spiral / section:accordion.
...
class Limits01BestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Limits 0 1 meaningful — clarified, named, and put to work in daily decisions.", Icons.grain_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Limits 0 1 over weeks, months and years.", Icons.diamond_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Limits 0 1 is alive in your life — not as theory, but as visible results.", Icons.workspace_premium_rounded),
      _Pillar("Frontiers", "Where Limits 0 1 stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.grain_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Limits 0 1 carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Limits 0 1.",
      "Share an insight about Limits 0 1 with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Limits 0 1.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Limits 0 1 is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Limits 0 1', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When limits 0 1 becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const Limits01View()),
