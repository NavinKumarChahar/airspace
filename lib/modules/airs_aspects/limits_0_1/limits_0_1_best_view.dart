...
import 'package:air_app/modules/airs_aspects/limits_0_1/limits_0_1_enhanced_view.dart';
...
class Limits01BestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Limits 0 1 meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Limits 0 1 over weeks, months and years.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Limits 0 1 is alive in your life — not as theory, but as visible results.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Limits 0 1 stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Limits 0 1 carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When limits 0 1 becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
