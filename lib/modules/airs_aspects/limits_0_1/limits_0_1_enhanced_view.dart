...
/// (the original Limits01View is embedded below the new sections).
///
/// Theme: Olive Grove | Layout: rings
class Limits01EnhancedView extends StatelessWidget {
  const Limits01EnhancedView({super.key});
