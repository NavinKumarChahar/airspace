...
class EntertainmentBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Entertainment meaningful — clarified, named, and put to work in daily decisions.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Entertainment over weeks, months and years.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Entertainment is alive in your life — not as theory, but as visible results.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Entertainment stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.loyalty_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Entertainment carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Entertainment is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When entertainment becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
