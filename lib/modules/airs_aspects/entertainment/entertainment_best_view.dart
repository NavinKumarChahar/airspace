...
/// EntertainmentBestView
/// Auto-generated showcase view — Design Pattern: Lime / hero:mesh / section:stats.
/// Wraps and preserves the original EntertainmentView at the bottom so no
...
class EntertainmentBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Entertainment meaningful — clarified, named, and put to work in daily decisions.", Icons.loyalty_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Entertainment over weeks, months and years.", Icons.flare_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Entertainment is alive in your life — not as theory, but as visible results.", Icons.whatshot_rounded),
      _Pillar("Frontiers", "Where Entertainment stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.loyalty_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Entertainment carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Entertainment.",
      "Share an insight about Entertainment with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Entertainment.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Entertainment is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Entertainment', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When entertainment becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
