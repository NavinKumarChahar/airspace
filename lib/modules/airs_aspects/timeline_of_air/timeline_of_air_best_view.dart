...
import 'package:air_app/modules/airs_aspects/timeline_of_air/timeline_of_air_enhanced_view.dart';
...
class TimelineOfAirBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Timeline Of Air meaningful — clarified, named, and put to work in daily decisions.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Timeline Of Air over weeks, months and years.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Timeline Of Air is alive in your life — not as theory, but as visible results.",
      Icons.psychology_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Timeline Of Air stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.flare_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Timeline Of Air carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Timeline Of Air is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When timeline of air becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: TimelineOfAirEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: TimelineOfAirView(isEmbedded: true)),
