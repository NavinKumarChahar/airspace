...
/// Auto-generated unique themed wrapper for Timeline Of Air.
/// Adds a fresh design + new content sections while preserving original content
/// (the original TimelineOfAirView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: burst
class TimelineOfAirEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const TimelineOfAirEnhancedView({this.isEmbedded = false, required this.isDark});
