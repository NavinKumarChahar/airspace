...
import 'unchecked_anomalies_view.dart';

/// UncheckedAnomaliesBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:spiral / section:gallery.
...
class UncheckedAnomaliesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Unchecked Anomalies meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Unchecked Anomalies over weeks, months and years.", Icons.insights_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Unchecked Anomalies is alive in your life — not as theory, but as visible results.", Icons.insights_rounded),
      _Pillar("Frontiers", "Where Unchecked Anomalies stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Unchecked Anomalies carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Unchecked Anomalies.",
      "Share an insight about Unchecked Anomalies with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Unchecked Anomalies.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Unchecked Anomalies is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Unchecked Anomalies', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.forest_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When unchecked anomalies becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const UncheckedAnomaliesView()),
