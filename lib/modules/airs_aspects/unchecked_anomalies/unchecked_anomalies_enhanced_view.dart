...
/// Auto-generated unique themed wrapper for Unchecked Anomalies.
/// Adds a fresh design + new content sections while preserving original content
/// (the original UncheckedAnomaliesView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: wave
class UncheckedAnomaliesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const UncheckedAnomaliesEnhancedView({
  ...
  static const Color _gold = Color(0xfffb923c);
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Unchecked Anomalies',
          child: Text(
