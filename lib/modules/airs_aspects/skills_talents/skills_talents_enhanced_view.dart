...
import 'skills_talents_best_view.dart';
import 'skills_talents_view.dart';

/// Auto-generated unique themed wrapper for Skills Talents.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SkillsTalentsView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: burst
class SkillsTalentsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SkillsTalentsEnhancedView({this.isEmbedded = false, required this.isDark});
    ...
    List<Widget> get slivers => [
          ...
          SliverToBoxAdapter(
            child: GestureDetector(
              onTap: () => Get.to(() => const SkillsTalentsBestView()),
              child: Container(
