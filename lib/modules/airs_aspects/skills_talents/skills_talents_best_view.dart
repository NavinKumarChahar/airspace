...
/// SkillsTalentsBestView
/// Auto-generated showcase view — Design Pattern: Indigo / hero:prism / section:numbered.
/// Wraps and preserves the original SkillsTalentsView at the bottom so no
...
class SkillsTalentsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Skills Talents meaningful — clarified, named, and put to work in daily decisions.", Icons.insights_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Skills Talents over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Skills Talents is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Skills Talents stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.insights_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Skills Talents carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Skills Talents.",
      "Share an insight about Skills Talents with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Skills Talents.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Skills Talents is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Skills Talents', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When skills talents becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
