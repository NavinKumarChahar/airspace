...
class CheckedAnomaliesBestView extends StatelessWidget {
  ...
  const CheckedAnomaliesBestView({super.key, this.isEmbedded = false});
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Checked Anomalies meaningful — clarified, named, and put to work in daily decisions.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Checked Anomalies over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Checked Anomalies is alive in your life — not as theory, but as visible results.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Checked Anomalies stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.rocket_launch_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Checked Anomalies carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Checked Anomalies is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When checked anomalies becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
