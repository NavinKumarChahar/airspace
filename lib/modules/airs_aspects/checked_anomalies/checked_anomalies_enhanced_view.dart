...
/// Auto-generated unique themed wrapper for Checked Anomalies.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CheckedAnomaliesView is embedded below the new sections).
///
/// Theme: Forest Moss | Layout: circles
class CheckedAnomaliesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const CheckedAnomaliesEnhancedView({
