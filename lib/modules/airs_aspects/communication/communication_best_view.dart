...
/// CommunicationBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:circles / section:bento.
/// Wraps and preserves the original CommunicationView at the bottom so no
...
class CommunicationBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Communication meaningful — clarified, named, and put to work in daily decisions.", Icons.workspace_premium_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Communication over weeks, months and years.", Icons.shield_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Communication is alive in your life — not as theory, but as visible results.", Icons.handshake_rounded),
      _Pillar("Frontiers", "Where Communication stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.workspace_premium_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Communication carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Communication.",
      "Share an insight about Communication with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Communication.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Communication is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Communication', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When communication becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
