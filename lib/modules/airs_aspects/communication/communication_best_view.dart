...
import 'package:air_app/modules/airs_aspects/communication/communication_enhanced_view.dart';
...
class CommunicationBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Communication meaningful — clarified, named, and put to work in daily decisions.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Communication over weeks, months and years.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Communication is alive in your life — not as theory, but as visible results.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Communication stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.workspace_premium_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Communication carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Communication is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When communication becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: CommunicationEnhancedView(isEmbedded: true),
          ),
