...
/// (the original BeingRecordedRewardedView is embedded below the new sections).
///
/// Theme: Magenta Pulse | Layout: grid
class BeingRecordedRewardedEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const BeingRecordedRewardedEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Being Recorded Rewarded',
          child: Text(
