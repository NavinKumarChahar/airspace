...
/// BeingRecordedRewardedBestView
/// Auto-generated showcase view — Design Pattern: Bronze / hero:split / section:numbered.
...
class BeingRecordedRewardedBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Being Recorded Rewarded meaningful — clarified, named, and put to work in daily decisions.", Icons.handshake_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Being Recorded Rewarded over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Being Recorded Rewarded is alive in your life — not as theory, but as visible results.", Icons.shield_rounded),
      _Pillar("Frontiers", "Where Being Recorded Rewarded stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.handshake_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Being Recorded Rewarded carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Being Recorded Rewarded.",
      "Share an insight about Being Recorded Rewarded with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Being Recorded Rewarded.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Being Recorded Rewarded is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Being Recorded Rewarded', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When being recorded rewarded becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const BeingRecordedRewardedView()),
