...
import 'package:air_app/modules/airs_aspects/being_recorded_rewarded/being_recorded_rewarded_enhanced_view.dart';
...
class BeingRecordedRewardedBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Being Recorded Rewarded meaningful — clarified, named, and put to work in daily decisions.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Being Recorded Rewarded over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Being Recorded Rewarded is alive in your life — not as theory, but as visible results.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Being Recorded Rewarded stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.handshake_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Being Recorded Rewarded carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Being Recorded Rewarded is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When being recorded rewarded becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: BeingRecordedRewardedEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: BeingRecordedRewardedView()),
