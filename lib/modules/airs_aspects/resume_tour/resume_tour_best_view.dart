...
import 'package:air_app/modules/airs_aspects/resume_tour/resume_tour_enhanced_view.dart';
...
class ResumeTourBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Resume Tour meaningful — clarified, named, and put to work in daily decisions.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Resume Tour over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Resume Tour is alive in your life — not as theory, but as visible results.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Resume Tour stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.forest_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Resume Tour carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When resume tour becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
