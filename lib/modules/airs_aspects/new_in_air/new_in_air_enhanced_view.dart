...
/// Auto-generated unique themed wrapper for New In Air.
/// Adds a fresh design + new content sections while preserving original content
/// (the original NewInAirView is embedded below the new sections).
///
/// Theme: Clay Earth | Layout: burst
class NewInAirEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const NewInAirEnhancedView({this.isEmbedded = false, required this.isDark});
