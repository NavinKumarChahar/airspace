...
/// NewInAirBestView
/// Auto-generated showcase view — Design Pattern: Sapphire / hero:diagonal / section:bento.
/// Wraps and preserves the original NewInAirView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class NewInAirBestView extends StatelessWidget {
  const NewInAirBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make New In Air meaningful — clarified, named, and put to work in daily decisions.", Icons.whatshot_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of New In Air over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove New In Air is alive in your life — not as theory, but as visible results.", Icons.diamond_rounded),
      _Pillar("Frontiers", "Where New In Air stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.whatshot_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch New In Air carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of New In Air.",
      "Share an insight about New In Air with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on New In Air.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when New In Air is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'New In Air', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When new in air becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
