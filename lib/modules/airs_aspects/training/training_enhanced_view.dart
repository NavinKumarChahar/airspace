...
/// Auto-generated unique themed wrapper for Training.
/// Adds a fresh design + new content sections while preserving original content
/// (the original TrainingView is embedded below the new sections).
///
/// Theme: Clay Earth | Layout: wave
class TrainingEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const TrainingEnhancedView({this.isEmbedded = false, required this.isDark});
  ...
  static const Color _gold = Color(0xff65a30d);
