...
import 'package:air_app/modules/airs_aspects/training/training_enhanced_view.dart';
...
class TrainingBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Training meaningful — clarified, named, and put to work in daily decisions.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Training over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Training is alive in your life — not as theory, but as visible results.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Training stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.flag_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Training carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When training becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: TrainingEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: TrainingView()),
