...
/// TrainingBestView
/// Auto-generated showcase view — Design Pattern: Coral / hero:beam / section:gallery.
...
class TrainingBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Training meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Training over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Training is alive in your life — not as theory, but as visible results.", Icons.star_rounded),
      _Pillar("Frontiers", "Where Training stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Training carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Training.",
      "Share an insight about Training with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Training.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Training is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Training', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When training becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const TrainingView()),
