...
/// ImaginationFeaturesBestView
/// Auto-generated showcase view — Design Pattern: Ocean / hero:mesh / section:cards.
/// Wraps and preserves the original ImaginationFeaturesView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ImaginationFeaturesBestView extends StatelessWidget {
  const ImaginationFeaturesBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Imagination Features meaningful — clarified, named, and put to work in daily decisions.", Icons.whatshot_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Imagination Features over weeks, months and years.", Icons.flag_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Imagination Features is alive in your life — not as theory, but as visible results.", Icons.favorite_rounded),
      _Pillar("Frontiers", "Where Imagination Features stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.whatshot_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Imagination Features carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Imagination Features.",
      "Share an insight about Imagination Features with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Imagination Features.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Imagination Features is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Imagination Features', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When imagination features becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
