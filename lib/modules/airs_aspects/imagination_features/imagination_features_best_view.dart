...
class ImaginationFeaturesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Imagination Features meaningful — clarified, named, and put to work in daily decisions.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Imagination Features over weeks, months and years.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Imagination Features is alive in your life — not as theory, but as visible results.",
      Icons.favorite_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Imagination Features stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.whatshot_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Imagination Features carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Imagination Features is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When imagination features becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          ...ImaginationFeaturesEnhancedView(
            isEmbedded: true,
            isDark: isDark,
          ).slivers,
