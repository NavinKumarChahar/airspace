...
/// Auto-generated unique themed wrapper for Imagination Features.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ImaginationFeaturesView is embedded below the new sections).
///
/// Theme: Rose Petal | Layout: rings
class ImaginationFeaturesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ImaginationFeaturesEnhancedView({this.isEmbedded = false, required this.isDark});
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                gold: _gold,
                eyebrow: 'OVERVIEW',
                title: 'About Imagination Features',
                child: Text(
