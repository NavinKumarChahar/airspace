...
class LoginBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Login meaningful — clarified, named, and put to work in daily decisions.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Login over weeks, months and years.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Login is alive in your life — not as theory, but as visible results.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Login stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.loyalty_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Login carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When login becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: LoginEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: LoginView(isEmbedded: true)),
