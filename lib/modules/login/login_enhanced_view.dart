...
/// Auto-generated unique themed wrapper for Login.
/// Adds a fresh design + new content sections while preserving original content
/// (the original LoginView is embedded below the new sections).
///
/// Theme: Neon Iris | Layout: rings
class LoginEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const LoginEnhancedView({this.isEmbedded = false, required this.isDark});
