...
import 'windup_else_view.dart';

/// WindupElseBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:diagonal / section:split.
/// Wraps and preserves the original WindupElseView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class WindupElseBestView extends StatelessWidget {
  const WindupElseBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Windup Else meaningful — clarified, named, and put to work in daily decisions.", Icons.explore_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Windup Else over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Windup Else is alive in your life — not as theory, but as visible results.", Icons.diamond_rounded),
      _Pillar("Frontiers", "Where Windup Else stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.explore_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Windup Else carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Windup Else.",
      "Share an insight about Windup Else with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Windup Else.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Windup Else is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Windup Else', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When windup else becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
