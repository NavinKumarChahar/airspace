...
import 'package:air_app/modules/airs_vision_details/windup_else/windup_else_enhanced_view.dart';
...
class WindupElseBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Windup Else meaningful — clarified, named, and put to work in daily decisions.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Windup Else over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Windup Else is alive in your life — not as theory, but as visible results.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Windup Else stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.explore_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Windup Else carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When windup else becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: WindupElseEnhancedView(isEmbedded: true)),
