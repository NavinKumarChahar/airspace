...
class PickGoodGoingBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Pick Good Going meaningful — clarified, named, and put to work in daily decisions.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Pick Good Going over weeks, months and years.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Pick Good Going is alive in your life — not as theory, but as visible results.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Pick Good Going stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.workspace_premium_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Pick Good Going carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Pick Good Going is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When pick good going becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
