...
/// PickGoodGoingBestView
/// Auto-generated showcase view — Design Pattern: Emerald / hero:diagonal / section:gallery.
/// Wraps and preserves the original PickGoodGoingView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class PickGoodGoingBestView extends StatelessWidget {
  const PickGoodGoingBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Pick Good Going meaningful — clarified, named, and put to work in daily decisions.", Icons.workspace_premium_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Pick Good Going over weeks, months and years.", Icons.diamond_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Pick Good Going is alive in your life — not as theory, but as visible results.", Icons.public_rounded),
      _Pillar("Frontiers", "Where Pick Good Going stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.workspace_premium_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Pick Good Going carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Pick Good Going.",
      "Share an insight about Pick Good Going with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Pick Good Going.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Pick Good Going is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Pick Good Going', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When pick good going becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const PickGoodGoingView()),
