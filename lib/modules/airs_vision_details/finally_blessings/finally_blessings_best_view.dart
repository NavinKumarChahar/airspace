...
/// FinallyBlessingsBestView
/// Auto-generated showcase view — Design Pattern: Lime / hero:orb / section:bento.
/// Wraps and preserves the original FinallyBlessingsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class FinallyBlessingsBestView extends StatelessWidget {
  const FinallyBlessingsBestView({super.key});

  static const Color _primary   = Color(0xFF84CC16);
  static const Color _secondary = Color(0xFF4D7C0F);
  static const Color _accent    = Color(0xFF06B6D4);
  static const Color _bgLight   = Color(0xFFF7FEE7);
  static const Color _bgDark    = Color(0xFF101A03);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Finally Blessings meaningful — clarified, named, and put to work in daily decisions.", Icons.flag_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Finally Blessings over weeks, months and years.", Icons.insights_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Finally Blessings is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Finally Blessings stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.flag_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Finally Blessings carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Finally Blessings.",
      "Share an insight about Finally Blessings with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Finally Blessings.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Finally Blessings is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Finally Blessings', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.flag_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 24),
              child: _BentoGrid(pillars: _pillars, primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.insights_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.psychology_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When finally blessings becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const FinallyBlessingsView()),
