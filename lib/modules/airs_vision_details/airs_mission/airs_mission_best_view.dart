...
import 'package:air_app/modules/airs_vision_details/airs_mission/airs_mission_enhanced_view.dart';
...
class AirsMissionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Airs Mission meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Airs Mission over weeks, months and years.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Airs Mission is alive in your life — not as theory, but as visible results.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Airs Mission stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Airs Mission carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When airs mission becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AirsMissionEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: AirsMissionView(isEmbedded: true)),
