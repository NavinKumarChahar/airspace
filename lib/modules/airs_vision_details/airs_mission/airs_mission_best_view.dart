...
import 'airs_mission_view.dart';

/// AirsMissionBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:beam / section:timeline.
/// Wraps and preserves the original AirsMissionView at the bottom so no
...
class AirsMissionBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Airs Mission meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Airs Mission over weeks, months and years.", Icons.handshake_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Airs Mission is alive in your life — not as theory, but as visible results.", Icons.diamond_rounded),
      _Pillar("Frontiers", "Where Airs Mission stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Airs Mission carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Airs Mission.",
      "Share an insight about Airs Mission with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Airs Mission.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Airs Mission is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Airs Mission', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When airs mission becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const AirsMissionView()),
