...
/// Auto-generated unique themed wrapper for Airs Mission.
/// Adds a fresh design + new content sections while preserving original content
/// (the original AirsMissionView is embedded below the new sections).
///
/// Theme: Twilight Lilac | Layout: stripes
class AirsMissionEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const AirsMissionEnhancedView({
  ...
  static const Color _soft = Color(0xffddd6fe);
