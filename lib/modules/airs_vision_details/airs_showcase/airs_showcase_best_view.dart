...
import 'package:air_app/modules/airs_vision_details/airs_showcase/airs_showcase_enhanced_view.dart';
...
class AirsShowcaseBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Airs Showcase meaningful — clarified, named, and put to work in daily decisions.",
      Icons.insights_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Airs Showcase over weeks, months and years.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Airs Showcase is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Airs Showcase stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.insights_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Airs Showcase carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Airs Showcase is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When airs showcase becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
