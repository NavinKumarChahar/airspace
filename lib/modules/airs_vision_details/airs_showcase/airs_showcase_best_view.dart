...
/// AirsShowcaseBestView
/// Auto-generated showcase view — Design Pattern: Sky / hero:orb / section:accordion.
/// Wraps and preserves the original AirsShowcaseView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class AirsShowcaseBestView extends StatelessWidget {
  const AirsShowcaseBestView({super.key});

  static const Color _primary   = Color(0xFF38BDF8);
  static const Color _secondary = Color(0xFF0284C7);
  static const Color _accent    = Color(0xFFF472B6);
  static const Color _bgLight   = Color(0xFFF0F9FF);
  static const Color _bgDark    = Color(0xFF021525);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Airs Showcase meaningful — clarified, named, and put to work in daily decisions.", Icons.insights_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Airs Showcase over weeks, months and years.", Icons.flare_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Airs Showcase is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Airs Showcase stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.insights_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Airs Showcase carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Airs Showcase.",
      "Share an insight about Airs Showcase with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Airs Showcase.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Airs Showcase is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Airs Showcase', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When airs showcase becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
