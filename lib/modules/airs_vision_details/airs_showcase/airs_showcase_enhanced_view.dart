...
/// (the original AirsShowcaseView is embedded below the new sections).
///
/// Theme: Bronze Age | Layout: diagonal
class AirsShowcaseEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const AirsShowcaseEnhancedView({this.isEmbedded = false, required this.isDark});
