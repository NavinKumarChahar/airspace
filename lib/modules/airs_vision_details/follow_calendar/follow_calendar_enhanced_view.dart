...
/// Auto-generated unique themed wrapper for Follow Calendar.
/// Adds a fresh design + new content sections while preserving original content
/// (the original FollowCalendarView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: blocks
class FollowCalendarEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const FollowCalendarEnhancedView({
