...
import 'follow_calendar_view.dart';

/// FollowCalendarBestView
/// Auto-generated showcase view — Design Pattern: Sunset / hero:spiral / section:split.
/// Wraps and preserves the original FollowCalendarView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class FollowCalendarBestView extends StatelessWidget {
  const FollowCalendarBestView({super.key});
  ...
  static const Color _bgLight   = Color(0xFFFFF7ED);
  static const Color _bgDark    = Color(0xFF1A0A05);

  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Follow Calendar meaningful — clarified, named, and put to work in daily decisions.", Icons.star_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Follow Calendar over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Follow Calendar is alive in your life — not as theory, but as visible results.", Icons.whatshot_rounded),
      _Pillar("Frontiers", "Where Follow Calendar stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.star_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Follow Calendar carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Follow Calendar.",
      "Share an insight about Follow Calendar with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Follow Calendar.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Follow Calendar is paired with reflection"),
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _HeroSpiral(primary: _primary, secondary: _secondary, accent: _accent),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 28, 20, 12),
              child: _Intro(title: 'Follow Calendar', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.interests_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.whatshot_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When follow calendar becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const FollowCalendarView()),
