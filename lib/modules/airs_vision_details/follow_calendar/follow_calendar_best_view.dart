...
import 'package:air_app/modules/airs_vision_details/follow_calendar/follow_calendar_enhanced_view.dart';
...
class FollowCalendarBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Follow Calendar meaningful — clarified, named, and put to work in daily decisions.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Follow Calendar over weeks, months and years.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Follow Calendar is alive in your life — not as theory, but as visible results.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Follow Calendar stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.star_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Follow Calendar carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Follow Calendar is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When follow calendar becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: FollowCalendarEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: FollowCalendarView(isEmbedded: true)),
