...
/// Auto-generated unique themed wrapper for Doctorate.
/// Adds a fresh design + new content sections while preserving original content
/// (the original DoctorateView is embedded below the new sections).
///
/// Theme: Clay Earth | Layout: circles
class DoctorateEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const DoctorateEnhancedView({this.isEmbedded = false, required this.isDark});
