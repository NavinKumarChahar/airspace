...
class DoctorateBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Doctorate meaningful — clarified, named, and put to work in daily decisions.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Doctorate over weeks, months and years.",
      Icons.insights_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Doctorate is alive in your life — not as theory, but as visible results.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Doctorate stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.forest_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Doctorate carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When doctorate becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          ...DoctorateEnhancedView(isEmbedded: true, isDark: isDark).slivers,
