...
/// Auto-generated unique themed wrapper for Statistics.
/// Adds a fresh design + new content sections while preserving original content
/// (the original StatisticsView is embedded below the new sections).
///
/// Theme: Ember Forge | Layout: wave
class StatisticsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const StatisticsEnhancedView({this.isEmbedded = false, required this.isDark});
