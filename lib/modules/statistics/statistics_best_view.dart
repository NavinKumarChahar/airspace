...
import 'package:air_app/modules/statistics/statistics_enhanced_view.dart';
...
class StatisticsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Statistics meaningful — clarified, named, and put to work in daily decisions.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Statistics over weeks, months and years.",
      Icons.lightbulb_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Statistics is alive in your life — not as theory, but as visible results.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Statistics stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.interests_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Statistics carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When statistics becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: StatisticsEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: StatisticsView(isEmbedded: true)),
