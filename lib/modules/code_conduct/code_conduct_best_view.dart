...
class CodeConductBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Code Conduct meaningful — clarified, named, and put to work in daily decisions.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Code Conduct over weeks, months and years.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Code Conduct is alive in your life — not as theory, but as visible results.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Code Conduct stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.local_fire_department_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Code Conduct carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When code conduct becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: CodeConductView(isEmbedded: true)),
