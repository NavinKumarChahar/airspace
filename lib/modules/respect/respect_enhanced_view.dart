...
/// Auto-generated unique themed wrapper for Respect.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RespectView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: diagonal
class RespectEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RespectEnhancedView({this.isEmbedded = false, required this.isDark});
