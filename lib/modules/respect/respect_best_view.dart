...
class RespectBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Respect meaningful — clarified, named, and put to work in daily decisions.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Respect over weeks, months and years.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Respect is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Respect stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.star_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Respect carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When respect becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: RespectEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: RespectView(isEmbedded: true)),
