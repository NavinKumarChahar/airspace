...
import 'script_strategy_view.dart';

/// ScriptStrategyBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:prism / section:numbered.
/// Wraps and preserves the original ScriptStrategyView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ScriptStrategyBestView extends StatelessWidget {
  const ScriptStrategyBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Script Strategy meaningful — clarified, named, and put to work in daily decisions.", Icons.diamond_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Script Strategy over weeks, months and years.", Icons.flare_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Script Strategy is alive in your life — not as theory, but as visible results.", Icons.bolt_rounded),
      _Pillar("Frontiers", "Where Script Strategy stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.diamond_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Script Strategy carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Script Strategy.",
      "Share an insight about Script Strategy with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Script Strategy.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Script Strategy is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Script Strategy', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'CORE LANDSCAPE', icon: Icons.diamond_rounded, color: _primary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'PRACTICE LOOP', icon: Icons.flare_rounded, color: _secondary, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _SectionLabel(label: 'BY THE NUMBERS', icon: Icons.bolt_rounded, color: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When script strategy becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ScriptStrategyView()),
