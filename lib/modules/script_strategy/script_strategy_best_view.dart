...
import 'package:air_app/modules/script_strategy/script_strategy_enhanced_view.dart';
...
class ScriptStrategyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Script Strategy meaningful — clarified, named, and put to work in daily decisions.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Script Strategy over weeks, months and years.",
      Icons.flare_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Script Strategy is alive in your life — not as theory, but as visible results.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Script Strategy stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.diamond_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Script Strategy carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Script Strategy is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When script strategy becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: ScriptStrategyEnhancedView(isEmbedded: true),
          ),
          SliverToBoxAdapter(child: ScriptStrategyView(isEmbedded: true)),
