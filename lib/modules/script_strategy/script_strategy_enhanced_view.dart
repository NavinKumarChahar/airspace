...
/// Auto-generated unique themed wrapper for Script Strategy.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ScriptStrategyView is embedded below the new sections).
///
/// Theme: Forest Moss | Layout: blocks
class ScriptStrategyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ScriptStrategyEnhancedView({
