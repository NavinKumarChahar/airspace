...
import 'punctuality_view.dart';

/// PunctualityBestView
/// Auto-generated showcase view — Design Pattern: Sky / hero:diagonal / section:accordion.
/// Wraps and preserves the original PunctualityView at the bottom so no
...
class PunctualityBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Punctuality meaningful — clarified, named, and put to work in daily decisions.", Icons.bolt_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Punctuality over weeks, months and years.", Icons.workspace_premium_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Punctuality is alive in your life — not as theory, but as visible results.", Icons.handshake_rounded),
      _Pillar("Frontiers", "Where Punctuality stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.bolt_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Punctuality carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Punctuality.",
      "Share an insight about Punctuality with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Punctuality.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Punctuality is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Punctuality', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When punctuality becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const PunctualityView()),
