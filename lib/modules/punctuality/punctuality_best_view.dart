...
import 'package:air_app/modules/punctuality/punctuality_enhanced_view.dart';
...
class PunctualityBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Punctuality meaningful — clarified, named, and put to work in daily decisions.",
      Icons.bolt_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Punctuality over weeks, months and years.",
      Icons.workspace_premium_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Punctuality is alive in your life — not as theory, but as visible results.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Punctuality stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.bolt_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Punctuality carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When punctuality becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: PunctualityEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: PunctualityView(isEmbedded: true)),
