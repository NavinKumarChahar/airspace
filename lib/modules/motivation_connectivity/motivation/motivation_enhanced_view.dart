...
/// Auto-generated unique themed wrapper for Motivation.
/// Adds a fresh design + new content sections while preserving original content
/// (the original MotivationView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: rings
class MotivationEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const MotivationEnhancedView({this.isEmbedded = false, required this.isDark});
