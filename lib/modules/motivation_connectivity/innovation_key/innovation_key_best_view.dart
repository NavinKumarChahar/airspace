...
import 'package:air_app/modules/motivation_connectivity/innovation_key/innovation_key_enhanced_view.dart';
...
class InnovationKeyBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Innovation Key meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Innovation Key over weeks, months and years.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Innovation Key is alive in your life — not as theory, but as visible results.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Innovation Key stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Innovation Key carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Innovation Key is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When innovation key becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: InnovationKeyEnhancedView(isEmbedded: true),
          ),
