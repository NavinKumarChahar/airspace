...
/// Auto-generated unique themed wrapper for Innovation Key.
/// Adds a fresh design + new content sections while preserving original content
/// (the original InnovationKeyView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: burst
class InnovationKeyEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const InnovationKeyEnhancedView({this.isEmbedded = false, required this.isDark});
