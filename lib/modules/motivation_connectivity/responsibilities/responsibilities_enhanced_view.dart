...
/// Auto-generated unique themed wrapper for Responsibilities.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ResponsibilitiesView is embedded below the new sections).
///
/// Theme: Ocean Deep | Layout: stripes
class ResponsibilitiesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ResponsibilitiesEnhancedView({
  ...
  static const Color _soft = Color(0xff99f6e4);
