...
/// Wraps and preserves the original OnboardView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class OnboardBestView extends StatelessWidget {
  const OnboardBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Onboard meaningful — clarified, named, and put to work in daily decisions.", Icons.grain_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Onboard over weeks, months and years.", Icons.psychology_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Onboard is alive in your life — not as theory, but as visible results.", Icons.lightbulb_rounded),
      _Pillar("Frontiers", "Where Onboard stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.grain_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Onboard carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Onboard.",
      "Share an insight about Onboard with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Onboard.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Onboard is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Onboard', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When onboard becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const OnboardView()),
