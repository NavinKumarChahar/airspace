...
/// Auto-generated unique themed wrapper for Onboard.
/// Adds a fresh design + new content sections while preserving original content
/// (the original OnboardView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: circles
class OnboardEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const OnboardEnhancedView({this.isEmbedded = false, required this.isDark});
