...
/// Wraps and preserves the original LiveFullestView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class LiveFullestBestView extends StatelessWidget {
  const LiveFullestBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Live Fullest meaningful — clarified, named, and put to work in daily decisions.", Icons.grain_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Live Fullest over weeks, months and years.", Icons.local_fire_department_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Live Fullest is alive in your life — not as theory, but as visible results.", Icons.flare_rounded),
      _Pillar("Frontiers", "Where Live Fullest stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.grain_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Live Fullest carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Live Fullest.",
      "Share an insight about Live Fullest with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Live Fullest.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Live Fullest is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Live Fullest', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When live fullest becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const LiveFullestView()),
