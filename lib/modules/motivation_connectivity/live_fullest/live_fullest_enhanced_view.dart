...
/// Auto-generated unique themed wrapper for Live Fullest.
/// Adds a fresh design + new content sections while preserving original content
/// (the original LiveFullestView is embedded below the new sections).
///
/// Theme: Forest Moss | Layout: rings
class LiveFullestEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const LiveFullestEnhancedView({this.isEmbedded = false, required this.isDark});
