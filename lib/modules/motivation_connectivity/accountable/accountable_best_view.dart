...
import 'package:air_app/modules/motivation_connectivity/accountable/accountable_enhanced_view.dart';
...
class AccountableBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Accountable meaningful — clarified, named, and put to work in daily decisions.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Accountable over weeks, months and years.",
      Icons.loyalty_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Accountable is alive in your life — not as theory, but as visible results.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Accountable stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.handshake_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Accountable carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When accountable becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: AccountableEnhancedView(isEmbedded: true)),
