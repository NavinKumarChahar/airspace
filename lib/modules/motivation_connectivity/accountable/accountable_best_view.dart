...
import 'accountable_view.dart';

/// AccountableBestView
/// Auto-generated showcase view — Design Pattern: Lime / hero:beam / section:tabs.
/// Wraps and preserves the original AccountableView at the bottom so no
...
class AccountableBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Accountable meaningful — clarified, named, and put to work in daily decisions.", Icons.handshake_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Accountable over weeks, months and years.", Icons.loyalty_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Accountable is alive in your life — not as theory, but as visible results.", Icons.explore_rounded),
      _Pillar("Frontiers", "Where Accountable stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.handshake_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Accountable carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Accountable.",
      "Share an insight about Accountable with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Accountable.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Accountable is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Accountable', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When accountable becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
