...
/// Auto-generated unique themed wrapper for Together Unison.
/// Adds a fresh design + new content sections while preserving original content
/// (the original TogetherUnisonView is embedded below the new sections).
///
/// Theme: Aurora Teal | Layout: blocks
class TogetherUnisonEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const TogetherUnisonEnhancedView({
        ...
        child: _Section(
          ...
          child: Column(
            children: [
              _Pillar(
                n: 1,
                text: 'Light a small candle',
                accent: _accent,
                gold: _gold,
              ),
              _Pillar(
                n: 2,
                text: 'Walk a short path',
                accent: _accent,
                gold: _gold,
              ),
              _Pillar(
                n: 3,
                text: 'Speak a kind word',
                accent: _accent,
                gold: _gold,
              ),
              _Pillar(
                n: 4,
                text: 'Keep a quiet promise',
                accent: _accent,
                gold: _gold,
              ),
            ],
