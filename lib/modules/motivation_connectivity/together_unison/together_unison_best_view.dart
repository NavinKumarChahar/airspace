...
/// TogetherUnisonBestView
/// Auto-generated showcase view — Design Pattern: Slate / hero:orb / section:accordion.
/// Wraps and preserves the original TogetherUnisonView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class TogetherUnisonBestView extends StatelessWidget {
  const TogetherUnisonBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Together Unison meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Together Unison over weeks, months and years.", Icons.diamond_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Together Unison is alive in your life — not as theory, but as visible results.", Icons.whatshot_rounded),
      _Pillar("Frontiers", "Where Together Unison stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Together Unison carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Together Unison.",
      "Share an insight about Together Unison with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Together Unison.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Together Unison is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Together Unison', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When together unison becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const TogetherUnisonView()),
