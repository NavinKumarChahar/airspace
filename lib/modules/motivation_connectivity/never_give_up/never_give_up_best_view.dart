...
import 'package:air_app/modules/motivation_connectivity/never_give_up/never_give_up_enhanced_view.dart';
...
class NeverGiveUpBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Never Give Up meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Never Give Up over weeks, months and years.",
      Icons.flag_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Never Give Up is alive in your life — not as theory, but as visible results.",
      Icons.local_fire_department_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Never Give Up stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Never Give Up carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Never Give Up is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When never give up becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: NeverGiveUpEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: NeverGiveUpView(isEmbedded: true)),
