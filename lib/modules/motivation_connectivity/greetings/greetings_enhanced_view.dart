...
/// Auto-generated unique themed wrapper for Greetings.
/// Adds a fresh design + new content sections while preserving original content
/// (the original GreetingsView is embedded below the new sections).
///
/// Theme: Rose Petal | Layout: grid
class GreetingsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const GreetingsEnhancedView({this.isEmbedded = false, required this.isDark});
  ...
  static const Color _soft = Color(0xfffecdd3);
