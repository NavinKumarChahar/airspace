...
/// GreetingsBestView
/// Auto-generated showcase view — Design Pattern: Crimson / hero:beam / section:numbered.
/// Wraps and preserves the original GreetingsView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class GreetingsBestView extends StatelessWidget {
  const GreetingsBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Greetings meaningful — clarified, named, and put to work in daily decisions.", Icons.bolt_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Greetings over weeks, months and years.", Icons.loyalty_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Greetings is alive in your life — not as theory, but as visible results.", Icons.star_rounded),
      _Pillar("Frontiers", "Where Greetings stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.bolt_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Greetings carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Greetings.",
      "Share an insight about Greetings with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Greetings.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Greetings is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Greetings', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When greetings becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const GreetingsView()),
