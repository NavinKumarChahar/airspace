...
/// Auto-generated unique themed wrapper for Get Connected.
/// Adds a fresh design + new content sections while preserving original content
/// (the original GetConnectedView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: circles
class GetConnectedEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const GetConnectedEnhancedView({
