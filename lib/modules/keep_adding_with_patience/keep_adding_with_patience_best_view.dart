...
class KeepAddingWithPatienceBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Keep Adding With Patience meaningful — clarified, named, and put to work in daily decisions.",
      Icons.grain_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Keep Adding With Patience over weeks, months and years.",
      Icons.auto_awesome_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Keep Adding With Patience is alive in your life — not as theory, but as visible results.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Keep Adding With Patience stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.grain_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Keep Adding With Patience carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Keep Adding With Patience is paired with reflection",
    ),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When keep adding with patience becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
