...
/// Auto-generated unique themed wrapper for Leadership.
/// Adds a fresh design + new content sections while preserving original content
/// (the original LeadershipView is embedded below the new sections).
///
/// Theme: Rose Petal | Layout: circles
class LeadershipEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const LeadershipEnhancedView({this.isEmbedded = false, required this.isDark});
