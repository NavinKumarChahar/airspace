...
import 'leadership_view.dart';

/// LeadershipBestView
/// Auto-generated showcase view — Design Pattern: Forest / hero:spiral / section:split.
/// Wraps and preserves the original LeadershipView at the bottom so no
...
class LeadershipBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Leadership meaningful — clarified, named, and put to work in daily decisions.", Icons.public_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Leadership over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Leadership is alive in your life — not as theory, but as visible results.", Icons.diamond_rounded),
      _Pillar("Frontiers", "Where Leadership stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.public_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Leadership carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Leadership.",
      "Share an insight about Leadership with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Leadership.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Leadership is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Leadership', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When leadership becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const LeadershipView()),
