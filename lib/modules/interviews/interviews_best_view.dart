...
import 'package:air_app/modules/interviews/interviews_enhanced_view.dart';
...
class InterviewsBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Interviews meaningful — clarified, named, and put to work in daily decisions.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Interviews over weeks, months and years.",
      Icons.handshake_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Interviews is alive in your life — not as theory, but as visible results.",
      Icons.shield_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Interviews stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.diamond_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Interviews carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When interviews becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
