...
/// Auto-generated unique themed wrapper for Interviews.
/// Adds a fresh design + new content sections while preserving original content
/// (the original InterviewsView is embedded below the new sections).
///
/// Theme: Ember Forge | Layout: burst
class InterviewsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const InterviewsEnhancedView({this.isEmbedded = false, required this.isDark});
