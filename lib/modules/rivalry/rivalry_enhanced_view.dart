...
/// Auto-generated unique themed wrapper for Rivalry.
/// Adds a fresh design + new content sections while preserving original content
/// (the original RivalryView is embedded below the new sections).
///
/// Theme: Cyber Lime | Layout: grid
class RivalryEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const RivalryEnhancedView({this.isEmbedded = false, required this.isDark});
