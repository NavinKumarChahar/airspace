...
class ServeBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Serve meaningful — clarified, named, and put to work in daily decisions.",
      Icons.rocket_launch_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Serve over weeks, months and years.",
      Icons.whatshot_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Serve is alive in your life — not as theory, but as visible results.",
      Icons.interests_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Serve stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.rocket_launch_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Serve carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When serve becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
          ...
          SliverToBoxAdapter(child: ServeEnhancedView(isEmbedded: true)),
          SliverToBoxAdapter(child: ServeView(isEmbedded: true)),
