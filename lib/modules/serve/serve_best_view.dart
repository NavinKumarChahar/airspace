...
import 'serve_view.dart';

/// ServeBestView
/// Auto-generated showcase view — Design Pattern: Magenta / hero:diagonal / section:stats.
/// Wraps and preserves the original ServeView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class ServeBestView extends StatelessWidget {
  const ServeBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Serve meaningful — clarified, named, and put to work in daily decisions.", Icons.rocket_launch_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Serve over weeks, months and years.", Icons.whatshot_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Serve is alive in your life — not as theory, but as visible results.", Icons.interests_rounded),
      _Pillar("Frontiers", "Where Serve stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.rocket_launch_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Serve carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Serve.",
      "Share an insight about Serve with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Serve.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Serve is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Serve', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When serve becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const ServeView()),
