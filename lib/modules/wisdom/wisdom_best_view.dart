...
/// WisdomBestView
/// Auto-generated showcase view — Design Pattern: Emerald / hero:diagonal / section:cards.
/// Wraps and preserves the original WisdomView at the bottom so no
...
class WisdomBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Wisdom meaningful — clarified, named, and put to work in daily decisions.", Icons.celebration_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Wisdom over weeks, months and years.", Icons.spa_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Wisdom is alive in your life — not as theory, but as visible results.", Icons.forest_rounded),
      _Pillar("Frontiers", "Where Wisdom stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.celebration_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Wisdom carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Wisdom.",
      "Share an insight about Wisdom with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Wisdom.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Wisdom is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Wisdom', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When wisdom becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const WisdomView()),
