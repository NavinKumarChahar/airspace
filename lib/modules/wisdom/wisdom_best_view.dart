...
class WisdomBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Wisdom meaningful — clarified, named, and put to work in daily decisions.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Wisdom over weeks, months and years.",
      Icons.spa_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Wisdom is alive in your life — not as theory, but as visible results.",
      Icons.forest_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Wisdom stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.celebration_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Wisdom carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
