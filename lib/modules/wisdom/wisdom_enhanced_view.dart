...
/// (the original WisdomView is embedded below the new sections).
///
/// Theme: Olive Grove | Layout: wave
class WisdomEnhancedView extends StatelessWidget {
  final bool isEmbedded;
  const WisdomEnhancedView({super.key, this.isEmbedded = false});
