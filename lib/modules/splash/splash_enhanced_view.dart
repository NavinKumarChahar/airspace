...
/// Auto-generated unique themed wrapper for Splash.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SplashScreen is embedded below the new sections).
///
/// Theme: Twilight Lilac | Layout: burst
class SplashEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SplashEnhancedView({this.isEmbedded = false, required this.isDark});
