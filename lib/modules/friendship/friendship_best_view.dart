...
/// FriendshipBestView
/// Auto-generated showcase view — Design Pattern: Plum / hero:grid / section:numbered.
/// Wraps and preserves the original FriendshipView at the bottom so no
...
class FriendshipBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Friendship meaningful — clarified, named, and put to work in daily decisions.", Icons.psychology_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Friendship over weeks, months and years.", Icons.grain_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Friendship is alive in your life — not as theory, but as visible results.", Icons.celebration_rounded),
      _Pillar("Frontiers", "Where Friendship stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.psychology_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Friendship carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Friendship.",
      "Share an insight about Friendship with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Friendship.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Friendship is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Friendship', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When friendship becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const FriendshipView()),
