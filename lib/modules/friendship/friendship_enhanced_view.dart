...
/// Auto-generated unique themed wrapper for Friendship.
/// Adds a fresh design + new content sections while preserving original content
/// (the original FriendshipView is embedded below the new sections).
///
/// Theme: Glacier Blue | Layout: stripes
class FriendshipEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const FriendshipEnhancedView({this.isEmbedded = false, required this.isDark});
