...
import 'hope_view.dart';

/// HopeBestView
/// Auto-generated showcase view — Design Pattern: Lime / hero:stripes / section:numbered.
/// Wraps and preserves the original HopeView at the bottom so no
...
class HopeBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Hope meaningful — clarified, named, and put to work in daily decisions.", Icons.bolt_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Hope over weeks, months and years.", Icons.interests_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Hope is alive in your life — not as theory, but as visible results.", Icons.psychology_rounded),
      _Pillar("Frontiers", "Where Hope stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.bolt_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Hope carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Hope.",
      "Share an insight about Hope with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Hope.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Hope is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Hope', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When hope becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const HopeView()),
