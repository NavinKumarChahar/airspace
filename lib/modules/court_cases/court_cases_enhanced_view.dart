...
/// Auto-generated unique themed wrapper for Court Cases.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CourtCasesView is embedded below the new sections).
///
/// Theme: Olive Grove | Layout: blocks
class CourtCasesEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const CourtCasesEnhancedView({this.isEmbedded = false, required this.isDark});
