...
class CourtCasesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Court Cases meaningful — clarified, named, and put to work in daily decisions.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Court Cases over weeks, months and years.",
      Icons.star_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Court Cases is alive in your life — not as theory, but as visible results.",
      Icons.celebration_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Court Cases stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.public_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Court Cases carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Quote(
                text:
                    'When court cases becomes a practice rather than an idea, the whole story changes.',
                primary: _primary,
                secondary: _secondary,
              ),
            ),
