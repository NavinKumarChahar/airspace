...
/// CourtCasesBestView
/// Auto-generated showcase view — Design Pattern: Ocean / hero:diagonal / section:accordion.
/// Wraps and preserves the original CourtCasesView at the bottom so no
...
class CourtCasesBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Court Cases meaningful — clarified, named, and put to work in daily decisions.", Icons.public_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Court Cases over weeks, months and years.", Icons.star_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Court Cases is alive in your life — not as theory, but as visible results.", Icons.celebration_rounded),
      _Pillar("Frontiers", "Where Court Cases stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.public_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Court Cases carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Court Cases.",
      "Share an insight about Court Cases with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Court Cases.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Court Cases is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Court Cases', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When court cases becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const CourtCasesView()),
