...
import 'enhancement_view.dart';

/// EnhancementBestView
/// Auto-generated showcase view — Design Pattern: Magenta / hero:wave / section:accordion.
/// Wraps and preserves the original EnhancementView at the bottom so no
/// content is lost. Designed to demonstrate unique UI/UX per page.
class EnhancementBestView extends StatelessWidget {
  const EnhancementBestView({super.key});
  ...
  static const List<_Pillar> _pillars = [
      _Pillar("Foundations", "The bedrock principles that make Enhancement meaningful — clarified, named, and put to work in daily decisions.", Icons.forest_rounded),
      _Pillar("Practices", "Repeatable habits and rituals that compound the impact of Enhancement over weeks, months and years.", Icons.local_fire_department_rounded),
      _Pillar("Outcomes", "Tangible markers that prove Enhancement is alive in your life — not as theory, but as visible results.", Icons.explore_rounded),
      _Pillar("Frontiers", "Where Enhancement stretches into new territory — challenges to attempt, questions to sit with, and edges to push.", Icons.forest_rounded)
  ];
  static const List<_StepCard> _steps = [
      _StepCard("Observe", "Watch Enhancement carefully without rushing to judgement. The first move is noticing."),
  ...
  static const List<String> _actions = [
      "Spend 10 minutes today journaling on one aspect of Enhancement.",
      "Share an insight about Enhancement with one person who matters to you.",
      "Identify one obstacle currently blocking your progress.",
      "Schedule a weekly review specifically focused on Enhancement.",
  ...
  static const List<_Stat> _stats = [
      ...
      _Stat("3x", "long-term impact when Enhancement is paired with reflection"),
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: _Intro(title: 'Enhancement', primary: _primary, secondary: _secondary, accent: _accent, onSurface: onSurface),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(20, 8, 20, 12),
              child: _Quote(text: 'When enhancement becomes a practice rather than an idea, the whole story changes.', primary: _primary, secondary: _secondary),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(child: const EnhancementView()),
