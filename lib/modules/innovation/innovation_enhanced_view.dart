...
/// Auto-generated unique themed wrapper for Innovation.
/// Adds a fresh design + new content sections while preserving original content
/// (the original InnovationView is embedded below the new sections).
///
/// Theme: Saffron Sun | Layout: wave
class InnovationEnhancedView extends StatelessWidget {
  const InnovationEnhancedView({super.key});
  ...
  static const Color _soft = Color(0xfffef3c7);
  static const Color _gold = Color(0xffef4444);
