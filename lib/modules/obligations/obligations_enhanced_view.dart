...
/// Auto-generated unique themed wrapper for Obligations.
/// Adds a fresh design + new content sections while preserving original content
/// (the original ObligationsView is embedded below the new sections).
///
/// Theme: Saffron Sun | Layout: circles
class ObligationsEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const ObligationsEnhancedView({
