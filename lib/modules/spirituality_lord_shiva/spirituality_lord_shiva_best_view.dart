...
import 'package:air_app/modules/spirituality_lord_shiva/spirituality_lord_shiva_enhanced_view.dart';
...
class SpiritualityLordShivaBestView extends StatelessWidget {
  ...
  static const List<_Pillar> _pillars = [
    _Pillar(
      "Foundations",
      "The bedrock principles that make Spirituality Lord Shiva meaningful — clarified, named, and put to work in daily decisions.",
      Icons.explore_rounded,
    ),
    _Pillar(
      "Practices",
      "Repeatable habits and rituals that compound the impact of Spirituality Lord Shiva over weeks, months and years.",
      Icons.public_rounded,
    ),
    _Pillar(
      "Outcomes",
      "Tangible markers that prove Spirituality Lord Shiva is alive in your life — not as theory, but as visible results.",
      Icons.diamond_rounded,
    ),
    _Pillar(
      "Frontiers",
      "Where Spirituality Lord Shiva stretches into new territory — challenges to attempt, questions to sit with, and edges to push.",
      Icons.explore_rounded,
    ),
  ];
  static const List<_StepCard> _steps = [
    _StepCard(
      "Observe",
      "Watch Spirituality Lord Shiva carefully without rushing to judgement. The first move is noticing.",
    ),
    _StepCard(
      "Orient",
  ...
  static const List<_Stat> _stats = [
    ...
    _Stat(
      "3x",
      "long-term impact when Spirituality Lord Shiva is paired with reflection",
    ),
