...
/// Auto-generated unique themed wrapper for Spirituality Lord Shiva.
/// Adds a fresh design + new content sections while preserving original content
/// (the original SpiritualityLordShivaView is embedded below the new sections).
///
/// Theme: Twilight Lilac | Layout: blocks
class SpiritualityLordShivaEnhancedView {
  final bool isEmbedded;
  final bool isDark;
  const SpiritualityLordShivaEnhancedView({
    ...
    SliverToBoxAdapter(
      child: Container(
        ...
        child: _Section(
          ...
          gold: _gold,
          eyebrow: 'OVERVIEW',
          title: 'About Spirituality Lord Shiva',
          child: Text(
